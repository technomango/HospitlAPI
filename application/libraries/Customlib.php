...
class Customlib
{
	...
	public function getHospitalAddressFormat()
    {
        $admin = $this->CI->session->userdata('hospitaladmin');
        if ($admin) {
	...
	public function getPatientSessionMaritalStatus()
    {
        $student_session = $this->CI->session->all_userdata();
        $session_Array   = $this->CI->session->userdata('patient');
        $studentMaritalstatus = $session_Array['marital_status'];
    ...
    {
        $result = $this->CI->setting_model->getCurrentHospitalAddress();
        return $result;
    }
	
	public function getHospitalEmail()
    {
        $result = $this->CI->setting_model->getCurrentHospitalEmail();
        return $result;
    }
	...
	public function getPatientHeaderDetails()
    {
        return "[patient_name] [patient_id] [marital_status] [dob] [age] [gender] [email] [phone] [address] [opd_ipd_no] [guardian_name] [opd_checkup_id] [consultant_doctor]";
    }
    ...
    public function notification_icon($notification_type)
    {
        ...
        $notification_icon_list = array(
            ...
            'opd' => 'fa-regular fa-stethoscope',
            'ipd' => 'fa-regular fa-procedures',
            'pharmacy' => 'fa-regular fa-mortar-pestle',
            'pathology' => 'fa-regular fa-flask',
            'radiology' => 'fa-regular fa-microscope',
            'blood_bank' => 'fa-regular fa-tint',
            'live_consultation' => 'fa-regular fa-video-camera ftlayer',
            'referral' => 'fa-regular fa-users',
            'certificate' => 'fa-regular fa-newspaper ftlayer',
            'ambulance' => 'fa-regular fa-ambulance',
            'birth_death_record' => 'fa-regular fa-birthday-cake',
            'human_resource' => 'fa-regular fa-sitemap'
        );
