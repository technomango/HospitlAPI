    ...
    public function getAllopdRecord()
    {
       ...
       if (!empty($custom_fields)) {
        ...
        $this->datatables
            ...
            ->searchable('patients.patient_name,patients.id,patients.image,patients.guardian_name,patients.gender,patients.mobileno,staff.name,visit_details.appointment_date'. $custom_field_column .',opd_details.patient_id,patients.is_antenatal')
