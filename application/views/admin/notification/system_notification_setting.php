        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <form action="<?php echo site_url('admin/notification/notification_setting') ?>"  method="post" accept-charset="utf-8">
                    <div class="box box-primary around10">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($this->rbac->hasPrivilege('system_notification_setting', 'can_edit')) { ?>
   											    <button type="button" class="button_template btn btn-primary btn-xs " id="load" data-record-id="<?php echo $note_value->id; ?>" data-loading-text="<i class='fa fa-spinner fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><i class="fa-regular fa-pencil-square"></i></button>
                                            <?php } ?>
                                            </td> 
                                        </tr>
                                        <?php
                      ...
                      <?php if ($this->rbac->hasPrivilege('system_notification_setting', 'can_edit')) { ?>
                        <div class="box-footer">
                            <button type="submit" class="btn btn-info pull-right" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('processing'); ?>"><i class="fa-regular fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                        </div> 
                       <?php } ?>                             
            </div>
            </form>   
