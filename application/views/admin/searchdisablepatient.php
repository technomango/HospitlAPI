...
<div class="content-wrapper">
	<section class="content-header">
       <h1><i class="fa-duotone fa-solid fa-users icono-menu-izquierda"></i>
            ...
            <span class="bread-span content-header-esconder"> <?php echo $this->lang->line('disabled_patient_list'); ?> </span>
            <span style="right: 40px; position: absolute;">
                        <div class="box-tools pull-right addmeeting">
                            <a href="<?php echo base_url() ?>admin/admin/search" class="btn btn-primary"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('patient_list'); ?></a> 
                        </div>               
            </span>
    </section>
    <!-- Main content -->
                ...
                <div class="modalicon"> 
                    <div id='edit_delete'>
                        <?php if ($this->rbac->hasPrivilege('revisit', 'can_edit')) { ?>
                            <a href="#"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>" ><i class="faregular fa-pen-to-square"></i></a>
                            <?php
                        }
    ...
    function getpatientData(id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#edit_delete').html("<?php if ($this->rbac->hasPrivilege('patient', 'can_edit')) { ?><a href='#' onclick='editRecord(" + id + ")' data-toggle='tooltip' title='<?php echo $this->lang->line('edit'); ?>' data-target='' data-toggle='modal'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa-regular fa-pen-to-square'></i></a><?php } ?> " + link + "<?php ?>");
