						...
						<div class="login-wrapper">
                            ...
                            <div class="login-right-wrap">  
                                ...
                                <div class="form-bottom">
                                    <h3 class="bolds"><?php echo $this->lang->line('admin_login'); ?></h3>
                                    <?php
                                    ...
                                    <br>
                                    <p><a href="<?php echo site_url('site/forgotpassword') ?>" class="forgot"><i class="fa-duotone fa-solid fa-lock" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i> ¿<?php echo $this->lang->line('forgot_password'); ?>?</a> </p> 
                                </div>
                            </div>
									</div>
								</div>
