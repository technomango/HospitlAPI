       ...
       <h1><i class="fa-duotone fa-solid fa-phone-office icono-menu-izquierda"></i>
            ...
            <span class="content-header-esconder mlr-10">
                <a href="<?php echo site_url('admin/admin/search') ?>"> 
                    <i class="fa-light fa-bell-exclamation"></i>
                </a> 
            </span> 
            <span class="bread-span content-header-esconder"> <?php echo $this->lang->line('complain_list'); ?> </span>
            <span style="right: 40px; position: absolute;">
                     <?php if ($this->rbac->hasPrivilege('complain', 'can_add')) {?>
                                    <a data-toggle="modal" data-target="#myModal" class="btn btn-primary complain"><i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('add_complain'); ?> </a>
                                <?php }?>    
								<a href="<?php echo base_url(); ?>admin/visitors" class="btn btn-primary"><i class="fa-regular fa-phone-office"></i> <?php echo $this->lang->line('front_office'); ?></a>
            </span>
    </section>
