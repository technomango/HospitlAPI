<div class="content-wrapper">
	<section class="content-header">
       <h1><i class="fa-duotone fa-solid fa-phone-office icono-menu-izquierda"></i>
            ...
            <span class="bread-span content-header-esconder"> <?php echo $this->lang->line('phone_call_log_list'); ?> </span>
            <span style="right: 40px; position: absolute;">
                       <?php if ($this->rbac->hasPrivilege('phone_call_log', 'can_add')) {?>
                                <a data-toggle="modal" data-target="#myModal" class="btn btn-primary call_log"><i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('add_call_log'); ?> </a>
                            <?php }?>       
