<div class="content-wrapper">
	<section class="content-header">
       <h1><i class="fa-duotone fa-solid fa-phone-office icono-menu-izquierda"></i>
            ...
            <span class="bread-span content-header-esconder"> <?php echo $this->lang->line('postal_dispatch_list'); ?> </span>
            <span style="right: 40px; position: absolute;">
                      <?php if ($this->rbac->hasPrivilege('postal_dispatch', 'can_add')) {?>
                                    <a data-toggle="modal" data-target="#myModal" class="btn btn-primary adddispatch"><i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('add_dispatch'); ?> </a>
                                <?php }?>     
