<div class="content-wrapper">
	<section class="content-header">
       <h1><i class="fa-duotone fa-solid fa-phone-office icono-menu-izquierda"></i>
             <?php echo $this->lang->line('front_office'); ?></h1>  
            <span class="content-header-esconder mlr-10">
                <a href="<?php echo site_url('admin/admin/search') ?>"> 
                    <i class="fa-light fa-users"></i>
                </a> 
            </span> 
            <span class="bread-span content-header-esconder"> <?php echo $this->lang->line('visitor_list'); ?> </span>
            <span style="right: 40px; position: absolute;">
                       <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_add')) {?>
                                <a data-toggle="modal" data-target="#myModal" class="btn btn-primary addvisitor"><i class="fa-regular fa-plus"></i> <span class="content-header-esconder"><?php echo $this->lang->line('add_visitor'); ?></span></a>
                            <?php }?>
                            <?php if ($this->rbac->hasPrivilege('phone_call_log', 'can_view')) {?>
                                <a href="<?php echo base_url(); ?>admin/generalcall" class="btn btn-primary"><i class="fa-regular fa-phone"></i> <span class="content-header-esconder"><?php echo $this->lang->line('phone_call_log'); ?></span></a>
                            <?php }if (($this->rbac->hasPrivilege('postal_dispatch', 'can_view')) || ($this->rbac->hasPrivilege('postal_receive', 'can_view'))) {?>
                                <button type="button" class="btn btn-primary dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
                                    <i class="fa-regular fa-mailbox-flag-up"></i> <span class="content-header-esconder"><?php echo $this->lang->line('postal'); ?> <span class="caret"></span></span>
                                </button>
                            ...
                            <?php }if ($this->rbac->hasPrivilege('complain', 'can_view')) {?>
                                <a href="<?php echo base_url(); ?>admin/complaint" class="btn btn-secondary"><i class="fa-regular fa-bell-exclamation"></i> <span class="content-header-esconder"><?php echo $this->lang->line('complain'); ?></span></a>
                            <?php }?>              
            </span>
    </section>
		...
		Swal.fire({
			  ...
			  confirmButtonText: "Si, !Eliminar!"
				  ...
				  if (result.isConfirmed) {
					  $.ajax({
                url: base_url + 'admin/visitors/deletevisitor',
                success: function (data){
					Swal.fire({
					  title: "!Eliminado!",
