<div class="content-wrapper">
	<section class="content-header">
       <h1><i class="fa-duotone fa-solid fa-phone-office icono-menu-izquierda"></i>
            ...
            <span class="bread-span content-header-esconder"> <?php echo $this->lang->line('postal_receive'); ?> </span>
            <span style="right: 40px; position: absolute;">
                      <?php if ($this->rbac->hasPrivilege('postal_receive', 'can_add')) {?>
                                        <a data-toggle="modal" data-target="#myModal" class="btn btn-primary receive"><i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('add_receive'); ?> </a>
                                    <?php }?>      
