...
foreach ($prefix_result as $prefix_key => $prefix_value) {
   ...
   <div class="form-group"> 
                                    <label for="<?php echo $prefix_value->type; ?>" class="control-label col-md-4 col-sm-4 col-xs-12"><?php echo $this->customlib->getPrefixnameByType($prefix_value->type); ?></label>
