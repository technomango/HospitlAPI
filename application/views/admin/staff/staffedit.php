...
<div class="content-wrapper">  
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-users icono-menu-izquierda"></i>
            ...
            <span class="bread-span"> <?php echo $this->lang->line('my_profile'); ?> <i class="fa-regular fa-chevron-left" style="font-size: 10px; color: #7047ee;"></i> Editar Perfil</span>
                ...
                <div class="box box-primary around20">
                    <form id="form1" action="<?php echo site_url('admin/staff/edit/' . $staff["id"]) ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                    ...
                                    <div class="row">                                        
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input autofocus="" id="employee_id" name="employee_id" placeholder="" value="<?php echo $staff["employee_id"] ?>" type="text" class="form-control" readonly="readonly" value="" />
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                        </div>
                    </form>
                </div>               
            </div>
