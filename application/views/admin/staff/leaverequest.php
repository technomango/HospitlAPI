<div class="content-wrapper"> 
	<section class="content-header">
       <h1><i class="fa-duotone fa-solid fa-users icono-menu-izquierda"></i>
            ...
            <span class="bread-span content-header-esconder"> <?php echo $this->lang->line('my_leaves'); ?> </span>
            <span style="right: 40px; position: absolute;">
                     <?php if ($this->rbac->hasPrivilege('apply_leave', 'can_add')) { ?>
                                <a href="#addleave" onclick="addLeave()" class="btn btn-primary">
                                    <i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('apply_leave'); ?></a>
                            <?php } if ($this->rbac->hasPrivilege('approve_leave_request', 'can_view')) { ?>
                                <a href="<?PHP echo base_url(); ?>admin/leaverequest/approveleaverequest" class="btn btn-primary">
                                    <i class="fa-regular fa-calendar-check"></i> <?php echo $this->lang->line('approve_leave_request'); ?></a>
                            <?php } ?>  
            </span>
    </section>
    <!-- Main content -->
