...
<div class="content-wrapper">  
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-users icono-menu-izquierda"></i>
            ...
            <span class="bread-span"> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('staff'); ?> </span>
            <span style="right: 40px; position: absolute;">
				
				<a class="btn btn-primary mr3 mt-md-0" href="<?php echo base_url(); ?>admin/staff/import" autocomplete="off"><i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('import_staff') ?></a>             
            </span>
...
$('#specialistOpt').multiselect({
    columns: 1,
    placeholder: '<?php echo $this->lang->line('select_specilist'); ?>',
    search: true  
});
...
<script>
  $(window).load(function(){
   Swal.fire({
  title: "<i class='fa-light fa-circle-user' style='font-size: 100px'></i>",
  width: 700,
  html: '<div style="font-size: 16px; text-align: justify;"><?php echo $this->lang->line('add_staff_message'); ?></div>',
});
  });
</script>