        ...
        <h1><i class="fa-duotone fa-solid fa-flask icono-menu-izquierda"></i>
            ...
            <span style="right: 40px; position: absolute;">
					 <?php if ($this->rbac->hasPrivilege('pathology_test', 'can_add')) {?>
                                <button  class="btn btn-primary pathology addtest" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Please wait.."><i class="fa-regular fa-plus"></i> <span class="content-header-esconder"><?php echo $this->lang->line('add_pathology_test'); ?></span></button>
                            <?php }?>
                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                <tr class="white-space-nowrap">
                                    ...
                                    <th class="text-right"><?php echo $this->lang->line('charge'); ?></th>
            ...
            <div class="modal-header modal-media-header">
                ...
                <div class="modalicon">
                    <div id='edit_delete'>
                        ...
                        <a href="#" data-target="#editModal" data-toggle="modal" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                    <?php }
...
$(document).on('click','.add-record',function(){
        ...
        var row = table.insertRow(table_len).outerHTML = "<tr id='row" + pathology_parmeter_rows + "'>" + div + "<td><button type='button'  class='closebtn delete_row'><i class='fa-regular fa-remove'></i></button></td></tr>";
        $('.select2').select2();
 ...
 $(document).on('select2:select','.charge_category',function(){
    ...
    ?><a onclick='delete_record(" + id + ")'  href='#'  data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('delete'); ?>'><i class='fa-regular fa-trash-can'></i></a><?php }?>");
