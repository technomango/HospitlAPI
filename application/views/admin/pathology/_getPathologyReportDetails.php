  ...
  <div class="row">
    ...
    <label for="approved_by"><?php echo $this->lang->line('approve_date'); ?><small class="req"> *</small></label>
     ...
     <div class="col-md-3">
	  ...
	  <div class="col-md-3">
		  <label for="approved_by"><?php echo $this->lang->line('files'); ?></label> 
		    <?php 
if($result->pathology_report != ""){
  ?>
  <a href="<?php echo site_url('admin/pathology/downloadReport/'.$result->id) ?>" ><i class="fa-regular fa-download"></i> <?php echo $result->report_name; ?></a>
  <?php
}
     ?> 
	</div>
  ...
  <input type="hidden" name="pathology_report_id" value="<?php echo $result->id;?>">
	   <table class="table table-hover table-sm">
        <thead>
                                <tr class="line">
                                   <td style="width: 5%">#</td>
                                   <td class="text-left"style="width: 25%"><?php echo $this->lang->line('test_parameter_name'); ?><small class="req"> *</small></td>
                                   <td class="text-left" style="width: 35%"><?php echo $this->lang->line('report_value'); ?></td>
