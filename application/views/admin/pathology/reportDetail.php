...
<div class="content-wrapper">
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-flask icono-menu-izquierda"></i>
             <?php echo $this->lang->line('pathology'); ?></h1>  
            ...
            <span class="content-header-esconder bread-span"> <?php echo $this->lang->line('pathology_tests'); ?>  </span>
            <span style="right: 40px; position: absolute;">
                       <?php if ($this->rbac->hasPrivilege('pathology_bill', 'can_add')) { ?>
                            ...
                            <?php if ($this->rbac->hasPrivilege('pathology_test', 'can_view')) { ?>   
                                <a data-toggle=""href="<?php echo base_url(); ?>admin/pathology/search"  class="btn btn-primary pathology"><i class="fa-regular fa-microscope"></i> <span class="content-header-esconder"><?php echo $this->lang->line('pathology_test'); ?></span> </a> 
                            <?php } ?>        
            </span>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div class="box box-primary around20">
                    <div class="box-header">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('pathology_tests'); ?></h3>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover ajaxlist" id="testreport" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('pathology_test_reports'); ?>">
                            ...
                            <tr>
                                ...
                                <th class="white-space-nowrap"><?php echo $this->lang->line('doctor'); ?></th>
                                <?php 
                                    if (!empty($fields)) {
                                ...
                                ?> 
                                <th class="white-space-nowrap"><?php echo $this->lang->line('discount'); ?></th>
                                <th class="white-space-nowrap"><?php echo $this->lang->line('amount'); ?></th>
                                <th class="white-space-nowrap"><?php echo $this->lang->line('paid_amount'); ?></th>
                                <th class="text-right white-space-nowrap"><?php echo $this->lang->line('balance_amount'); ?></th>
                            </tr>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-11">
						...
						<div class="col-lg-8 col-md-7 col-sm-8 col-xs-8">
							<div class="p-2 select2-full-width">
								<select class="form-control patient_list_ajax" placeholder="" id="addpatient_id" name='patientid' onchange="get_PatientDetails(this.value)">
    ...
    function viewDetailReport(id,pathology_id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#edit_deletereport').html("<?php if ($this->rbac->hasPrivilege('pathology_bill', 'can_view')) { ?><a href='#' data-toggle='tooltip' onclick='printData(" + id + "," + pathology_id + ")' data-original-title='<?php echo $this->lang->line('print'); ?>'><i class='fa-regular fa-print'></i></a> <?php } ?>");
