                        ...
                        <div class="box-tools pull-right">
                            <form id="form1" action="<?php echo site_url('admin/admin/backup') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" role="form">
                                ...
                                <?php if ($this->rbac->hasPrivilege('backup', 'can_add')) { ?>
                                    <button class="btn btn-primary btn-info" type="submit" name="backup" value="backup"><i class="fa-regular fa-plus-square-o"></i>   <?php echo $this->lang->line('create_backup'); ?></button>
                                <?php } ?>
                            </form>
                        </div>
                    </div>
                                            ...
                                            foreach ($dbfileList as $data) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="mailbox-name">
                                                        <a href="<?php echo site_url('admin/admin/downloadbackup/' . $data) ?>" class="btn btn-success" ><i class="fa-regular fa-download"></i> <?php echo $this->lang->line('download'); ?></a>
                                                    </td>
                                                    <?php if ($this->rbac->hasPrivilege('restore', 'can_view')) { ?>
                                                        <td class="mailbox-name">
                                                            <form class="formrestore" action="<?php echo site_url('admin/admin/backup') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" role="form">
                                                                ...
                                                                <button class="btn btn-warning" type="submit" name="backup" value="restore"><i class="fa-regular fa-plus-square-o"></i>  <?php echo $this->lang->line('restore'); ?> </button>
                                                            </form>
                                                        </td>
                                                    <?php } ?>
                                                    <td class="mailbox-name">
                                                        <form class="formdelete" method="post" role="form" name="employeeform" id="employeeform" accept-charset="utf-8"  action="<?php echo site_url('admin/admin/dropbackup/' . $data); ?>" >
                                                            ...
                                                            <?php if ($this->rbac->hasPrivilege('backup', 'can_delete')) { ?>
                                                                <button class="btn btn-danger" type="submit" name="backup" value="restore"><i class="fa-regular fa-trash"></i>  <?php echo $this->lang->line('delete'); ?></button>
                                                            <?php } ?>
                                                        </form></td>
                                                </tr>
                                                <?php
                    ...
                    <div class="box box-warning">
                        ...
                        <form role="form" action="<?php echo site_url('admin/admin/backup') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-footer">
                                <button class="btn btn-primary pull-right" type="submit" name="backup" value="upload"><i class="fa fa-upload"></i> <?php echo $this->lang->line('upload'); ?></button>
                            </div>
                        </form>
                    </div>
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">   
                                <a class="btn btn-info" data-toggle="tooltip" title="<?php echo $this->lang->line('cron_secret_key') ?>" href="<?php echo base_url() . "admin/admin/addCronsecretkey/" . $settinglist[0]['id'] ?>"><?php
