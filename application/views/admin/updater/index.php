<style type="text/css">
    ...
    .upgradeup{}
    .update-list li h5{font-family: 'Poppins', 'Source Sans Pro', sans-serif;}
                            ...
                            <div class="col-md-12">
                                <div class="text-primary">
                                    <ul class="update-list">
                                        <?php echo base64_decode('');?>
                                    </ul>
                                </div>
                              </div>
							  <?php
