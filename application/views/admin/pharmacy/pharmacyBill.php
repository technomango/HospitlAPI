...
<div class="content-wrapper">
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-prescription-bottle-pill icono-menu-izquierda"></i>
            ...
            <span class="content-header-esconder bread-span"> <?php echo $this->lang->line('pharmacy_bill'); ?> </span>
            <span style="right: 40px; position: absolute;">
				
				<?php if ($this->rbac->hasPrivilege('pharmacy_bill', 'can_add')) {?>  
                            <button type="button" class="btn btn-primary generatebill" id="load1" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><i class="fa-regular fa-plus"></i> <span class="content-header-esconder"><?php echo $this->lang->line('generate_bill'); ?></span></button>
                            <?php }?>
				
				<?php if ($this->rbac->hasPrivilege('medicine', 'can_view')) {?>
                                <a href="<?php echo base_url(); ?>admin/pharmacy/search" class="btn btn-secondary"><i class="fa-regular fa-reorder"></i> <span class="content-header-esconder"><?php echo $this->lang->line('medicines'); ?></span></a>
                            <?php }?>
                ...
                <div class="box box-primary around20">
                    <div class="box-header"> 
                        <h3 class="box-title titlefix">
                            <?php echo $this->lang->line('pharmacy_bill_list');
                            ?>
                        </h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                     ...
                     <div class="table-responsive">
                        <table class="table table-responsive table-striped table-bordered table-hover ajaxlist" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('pharmacy_bill'); ?>"> <thead>
                                <tr>
            ...
            <div class="modal-header modal-media-header">
                ...
                <div class="modalicon">
                    <div id='edit_deletebill'>
                        <a href="#" data-target="#edit_prescription" data-placement="bottom" data-toggle="modal" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                        <a href="#" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="<?php echo $this->lang->line('delete'); ?>"><i class="fa-regular fa-trash-can"></i></a>
                    </div>
                </div>
    ...
    <div class="modal-dialog pup100" role="document">
        <div class="modal-content modal-media-content">
            ...
            <div class="modal-header modal-media-header around20">
                 <button type="button" class="close pupclose" data-dismiss="modal"><i class="fa-regular fa-xmark"></i></button>
				<h4 class="modal-title" style="padding: 14px 15px;"><?php echo $this->lang->line('generate_bill'); ?></h4>
            ...
            <div class="pup-scroll-area around20">
                <div class="tabinsetbottom pt5">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-4 text-right text-md-left pt10s pb10">
                ...
                <div class="modal-footer sticky-footer">
                    <div class="pull-right">
                        <button type="submit" data-loading-text="<?php echo $this->lang->line('processing'); ?>" id="saveprint" class="btn btn-primary printsavebtn"><i class="fa fa-print"></i> <?php echo $this->lang->line('save_print'); ?></button>                        
                        <button type="submit" data-loading-text="<?php echo $this->lang->line('processing'); ?>" style="" id="billsave" class="btn btn-secondary"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                    </div>
                </div>
            </form>
        </div><!--./modal-body-->
...
( function ( $ ) {
    'use strict';
    $(document).ready(function () {
        initDatatable('ajaxlist','admin/pharmacy/getpharmacybillDatatable',[],[],10,
            [
