                            ...
                            <div class="row">
                                <div class="col-md-12">    
                                        ...
                                        <table class="table tableover table-striped mb0 table-bordered table-hover tablefull12 tblProducts" id="tableID">
                                            <thead>
                                                <tr class="font13 white-space-nowrap">
                                                    <th class="th-texto" width="15%"><?php echo $this->lang->line('medicine_category'); ?><small class="req" style="color:red;"> *</small></th>
                                                    <th class="th-texto" width="15%"><?php echo $this->lang->line('medicine_name'); ?><small class="req" style="color:red;"> *</small></th>
                                                    <th class="th-texto" width="15%"><?php echo $this->lang->line('batch_no'); ?> <small class="req" style="color:red;">*</small></th>
                                                    <th class="th-texto" width="15%"><?php echo $this->lang->line('expiry_date'); ?><small class="req" style="color:red;"> *</small></th>
                                                    <th class="th-texto" class="text-right" width="15%"><?php echo $this->lang->line('available_qty'); ?> <?php echo " | " . $this->lang->line('quantity'); ?><small class="req" style="color:red;"> *</small></th>
                                                    <th class="th-texto" class="text-right" width="13%"><?php echo $this->lang->line('sale_price') . ' (' . $currency_symbol . ')'; ?><small class="req" style="color:red;"> *</small></th>
                                                    <th class="th-texto" class="" width="11%"><?php echo $this->lang->line('tax'); ?></th>
                                                    <th class="th-texto" class="text-right"><?php echo $this->lang->line('amount') . " (" . $currency_symbol . ")"; ?><small class="req" style="color:red;"> *</small></th>
                                    ...
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                       ...
                                       <a class="btn btn-info addplus-sm add-record mb10" data-added="0"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add')?></a>  
                                    </div>
                                    <div class="divider"></div>                                    
                                    <div class="row">
                                        <div class="col-sm-6 pr20s">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label class="labels" for="exampleInputFile">
...
<?php }?>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label class="labels"><?php echo $this->lang->line('doctor_name'); ?></label>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <label class="labels"><?php echo $this->lang->line('note'); ?></label>
                                        ...
                                        <div class="col-sm-6">
                                            <table class="printablea4">
                                                <tr>
                                                    <th class="th-texto" width="40%"><?php echo $this->lang->line('total') . " (" . $currency_symbol . ")"; ?></th>
                                                ...
                                                <tr>
                                                    <th class="th-texto"><?php echo $this->lang->line('discount') . " (" . $currency_symbol . ")"; ?></th>
                                                    <td class="text-right ipdbilltable">
                                                        <span style="float: left;font-size: 16px; padding-left: 5px;"> %</span>
                                                <input type="text" placeholder="<?php echo $this->lang->line('discount'); ?>" name="discount_percent" id="discount_percent" class="form-control discount_percent" style="width: 70%; float: none;font-size: 16px;"/></td>
                                                    <td class="text-right ipdbilltable">
                                        <input type="text" onkeyup="get_percentage(this.value)" placeholder="<?php echo $this->lang->line('discount'); ?>" value="0" name="discount" id="discount" style="width: 61%; float: right" class="form-control discount"/></td>
                                                </tr>
                                                <tr>
                                                    <th class="th-texto"><?php echo $this->lang->line('tax') . " (" . $currency_symbol . ")"; ?></th>
                                                    <td class="text-right ipdbilltable">
                                                    </td>
                                                    <td class="text-right ipdbilltable">
                                                        <input type="text" placeholder="<?php echo $this->lang->line('tax'); ?>" name="tax" value="0" id="tax" style="width: 61%; float: right" class="form-control tax"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="th-texto"><?php echo $this->lang->line('net_amount') . " (" . $currency_symbol . ")"; ?></th>
