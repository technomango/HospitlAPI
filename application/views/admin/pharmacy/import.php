...
<div class="content-wrapper">
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-prescription-bottle-pill icono-menu-izquierda"></i>
            ...
            <span class="bread-span"> <?php echo $this->lang->line('medicines_stock'); ?> <i class="fa-regular fa-upload"></i> <?php echo $this->lang->line('import_medicine'); ?> </span>
            <span style="right: 40px; position: absolute;">
                        <?php if ($this->rbac->hasPrivilege('import_medicine', 'can_view')) { ?>       
                                <a href="<?php echo site_url('admin/pharmacy/exportformat') ?>">
                                    <button class="btn btn-primary"><i class="fa-regular fa-download"></i> <?php echo $this->lang->line('download_sample_data'); ?></button>
                                </a>
                            <?php } ?>          
            </span>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-primary around20">
                    <div class="box-header">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('import_medicine'); ?></h3>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 pt20">
                                    <button type="submit" class="btn btn-info pull-right"><i class="fa-regular fa-upload"></i> <?php echo $this->lang->line('import_medicine'); ?></button>
                                </div> 
                            </div>
                        </div>
                    </form>
