                        ...
                        <table class="table table-striped table-bordered table-hover example" id="detail" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-right"><?php echo $this->lang->line('packing_qty'); ?></th>
                                    <th class="text-right"><?php echo $this->lang->line('purchase_rate'); ?></th> 
                                    <th class="text-right"><?php echo $this->lang->line('quantity'); ?></th>
                                    <th class="text-right"><?php echo $this->lang->line('amount'); ?></th>
                                    <th class="text-right"><?php echo $this->lang->line('sale_price'); ?></th>
                            ...
                            <tbody>
                                ...
                                foreach ($result as $detail) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $detail->packing_qty ?></td>    
                                        <td><?php echo $currency_symbol.number_format ($detail->purchase_price, 2, '.', '') ?></td>
                                        <td><?php echo $detail->quantity ?></td> 
                                        <td><?php echo $currency_symbol.number_format ($detail->amount, 2, '.', ''); ?></td>  
                                        <td><?php echo $currency_symbol.number_format ($detail->sale_rate, 2, '.', ''); ?></td>
                                        <td class="text-right"><?php if ($this->rbac->hasPrivilege('medicine', 'can_delete')) { ?><a href="#" class="btn btn-default btn-xs" data-toggle="tootip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_batch('<?php echo $detail->id ?>', '<?php echo $detail->pharmacy_id ?>')"><i class="fa-regular fa-trash-can"></i></a><?php } ?></td>
                                    </tr>
                                    <?php
                                    $count++;
                                }
