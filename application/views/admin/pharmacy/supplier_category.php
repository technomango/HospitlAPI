                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input autofocus="" name="address" placeholder="" type="text" class="form-control text-addr-inp" value="<?php
                                    if (isset($result)) {
                                        echo $result["address"];
                                    }
                                    ?>" />
                ...
                <div class="modal-body pt0 pb0">
                    ...
                    <div class="row ptt10">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('address'); ?></label>
                                <input autofocus="" id="address" name="address" placeholder="" type="text" class="form-control text-addr-inp" value="<?php
                                if (isset($result)) {
                                    echo $result["address"];
                                }
                                ?>" />
