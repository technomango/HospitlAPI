                ...
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        ...
                        <?php if ($this->rbac->hasPrivilege('unit_type', 'can_add')) { ?>
                            <button type="button" data-record-id="0" class="btn btn-primary addunittype add_unit_type_modal" id="load2" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing') ?>"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_unit_type'); ?></button>
                        <?php } ?>
                        </div>
                    </div>
                    <div class="box-body">
