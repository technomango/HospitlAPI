...
<div class="content-wrapper">
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-tombstone icono-menu-izquierda"></i>
             <?php echo $this->lang->line('deaths'); ?></h1>  
            <span class="content-header-esconder mlr-10">
                <a href="<?php echo site_url('admin/birthordeath/death') ?>"> 
                    <i class="fa-light fa-coffin-cross"></i>
                </a> 
            </span> 
            <span class="content-header-esconder bread-span"> <?php echo $this->lang->line('death_records'); ?> </span>
            <span style="right: 40px; position: absolute;">
						 <?php
                            if ($this->rbac->hasPrivilege('death_record', 'can_add')) {
                            ?>
                                <a data-toggle="modal" onclick="holdModal('myModal')" class="btn btn-primary deathrecord"><i class="fa-regular fa-plus"></i> <span class="content-header-esconder"><?php echo $this->lang->line('add_death_record'); ?></span></a>
                            <?php }?>          
            </span>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary around20">
                    ...
                    <div class="box-body">
                        <div class="download_label"><?php echo $this->lang->line('death_records'); ?></div>
