...
<div class="content-wrapper">
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-baby icono-menu-izquierda"></i>
             <?php echo $this->lang->line('births'); ?></h1>  
            <span class="content-header-esconder mlr-10">
                <a href="<?php echo site_url('admin/birthordeath/') ?>"> 
                    <i class="fa-light fa-bottle-baby"></i>
                </a> 
            </span> 
            <span class="content-header-esconder bread-span"> <?php echo $this->lang->line('birth_records'); ?> </span>
            <span style="right: 40px; position: absolute;">
						 <?php
                            if ($this->rbac->hasPrivilege('birth_record', 'can_add')) {
                                ?>
                                <a data-toggle="modal" onclick="holdModal('myModal')" class="btn btn-primary birthrecord"><i class="fa-regular fa-plus"></i> <span class="content-header-esconder"><?php echo $this->lang->line('add_birth_record'); ?></span></a>
                            <?php }?>           
            </span>
            ...
            <div class="col-md-12">
                <div class="box box-primary around20">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('birth_records'); ?></h3>
    ...
    function viewDetail(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.document) {
                    $('#download_document').html("<a href='<?php echo base_url(); ?>admin/birthordeath/download/" + downloadid + "' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('download'); ?>'><i class='fa-regular fa-download'></i></a>");
                }
            },
        });
    }
