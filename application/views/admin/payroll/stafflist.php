            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo $this->lang->line('staff_generate_payroll'); ?></h3>             
                    </div>
                    <form id='form1' action="<?php echo site_url('admin/payroll') ?>"  method="post" accept-charset="utf-8">
                        ...
                        <div class="box-footer pt-0">
                            <button type="submit" name="search" value="search" class="btn btn-primary pull-right checkbox-toggle"><i class="fa-regular fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                        </div>
                    </form>
                    <?php
                    if (isset($resultlist)) {
                        ?>
                        <div class=""></div>  
                        <div class="box border0 clear around20">
                                                ...
                                                <?php if ($status == "paid") { ?>
                                                    <td class="pull-right no-print">
                                                        ...
                                                        if ($this->rbac->hasPrivilege('staff_payroll', 'can_add')) {
                                                            ?>
                                                            <a class="btn btn-default btn-xs" onclick="return confirm('<?php echo $this->lang->line('are_you_sure_you_want_to_revert_this_record') ?>')" href="<?php echo base_url() . "admin/payroll/revertpayroll/" . $staff["payslip_id"] . "/" . $month_selected . "/" . date("Y") . "/" . $role_selected ?>" title="Revertir" data-toggle="tooltip" data-title="Revertir" >
                                                ...
                                                <?php if ($status == "generated") { ?>
                                                    <td class="pull-right no-print">                                                        
                                                        ...
                                                        if ($this->rbac->hasPrivilege('staff_payroll', 'can_edit')) {
                                                            ?>                                                    
                                                            <a href="<?php echo site_url('admin/payroll/edit/'.$staff["payslip_id"]) ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit') ?>"><i class="fa-regular fa-pen-to-square"> </i> </a>                                                            
                                                        <?php }
                                                        
                                                        if ($this->rbac->hasPrivilege('staff_payroll', 'can_delete')) {
                                                            ?>
                                                            <a href="<?php echo base_url() ?>admin/payroll/deletepayroll/<?php echo $staff["payslip_id"] . "/" . $month_selected . "/" . date("Y") . "/" . $role_selected ?>" class="btn btn-default btn-xs" onclick="return confirm('<?php echo $this->lang->line('are_you_sure_you_want_to_revert_this_record') ?>')" title="Revertir" data-toggle="tooltip" data-title="Revertir">
            ...
            <div class="modal-body">
                <div class="row">
                    <form role="form" id="schsetting_form" action="<?php echo site_url('admin/payroll/paymentSuccess') ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('amount_payment'); ?></label>
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('payment_mode'); ?> </label><span class="req"> *</span><br/><span id="remark">
                            </span>
