...
<div class="content-wrapper">
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-droplet icono-menu-izquierda"></i>
            ...
            <span class="content-header-esconder bread-span"> <?php echo $this->lang->line('blood_issue_details'); ?> </span>
            <span style="right: 40px; position: absolute;">
				 <?php if ($this->rbac->hasPrivilege('blood_issue', 'can_add')) { ?>
                                <button type="button" class="btn btn-primary issueblood" id="load1" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><i class="fa fa-plus"></i> <span class="content-header-esconder"><?php echo $this->lang->line('issue_blood'); ?></span></button>
                            <?php } ?>          
            </span>
    </section>
    <!-- Main content -->
                            ...
                            <div class="col-lg-3 col-md-5 col-sm-4 col-xs-2">
                             <div class="form-group15">
                              <?php if ($this->rbac->hasPrivilege('patient', 'can_add')) {?>
                               <a data-toggle="modal" id="add" onclick="holdModal('myModalpa')" class="modalbtnpatient btn btn-primary  w-lg-100"><i class="fa fa-plus"></i>  <span><?php echo $this->lang->line('new_patient'); ?></span></a>
                               <?php }?>
                             </div> 
                            </div>
                           </div>
