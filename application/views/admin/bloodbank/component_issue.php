	...
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-droplet icono-menu-izquierda"></i>
            ...
            <span class="content-header-esconder mlr-10">
                <a href="<?php echo site_url('admin/bloodbank/component_issue') ?>"> 
                    <i class="fa-light fa-user-magnifying-glass"></i>
                </a> 
            </span> 
            <span class="content-header-esconder bread-span"> <?php echo $this->lang->line('components_issue_details'); ?> </span>
            <span style="right: 40px; position: absolute;">
				<?php if ($this->rbac->hasPrivilege('issue_component', 'can_add')) {?>

                                 <button type="button" class="btn btn-primary issuecomponent" id="load1" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><i class="fa fa-plus"></i> <span class="content-header-esconder"><?php echo $this->lang->line('issue_component'); ?></span></button>
                             <?php } if ($this->rbac->hasPrivilege('blood_bank_components', 'can_view')) {?>
                             <a href="<?php echo base_url(); ?>admin/bloodbank/components" class="btn btn-primary"><i class="fa fa-reorder"></i> <span class="content-header-esconder"><?php echo $this->lang->line('components'); ?></span></a>
                         <?php } ?>         
            </span>
    </section>
                        ...
                        <table class="table table-striped table-bordered table-hover ajaxlist" width="100%" data-export-title="<?php echo $this->lang->line('components_issue_details'); ?>">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-right"><?php echo $this->lang->line('balance_amount'); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
