        ...
        <h1><i class="fa-duotone fa-solid fa-droplet icono-menu-izquierda"></i>
            ...
            <span style="right: 40px; position: absolute;">
						<?php if ($this->rbac->hasPrivilege('blood_donor', 'can_add')) {?>
                                <a data-toggle="modal" onclick="holdModal('myModal')" class="btn btn-primary addblood"><i class="fa-regular fa-user-plus"></i> <span class="content-header-esconder"><?php echo $this->lang->line('add_blood_donor'); ?></span></a>
                            <?php }?>            
            </span>
    </section>
    <!-- Main content -->
