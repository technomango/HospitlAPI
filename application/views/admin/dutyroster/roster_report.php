...
<div class="content-wrapper">
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-clock icono-menu-izquierda"></i>
             <?php echo $this->lang->line('duty_roster'); ?></h1>  
            <span class="content-header-esconder mlr-10">
                <a href="<?php echo site_url('admin/dutyroster/roster_report/') ?>"> 
                    <i class="fa-light fa-calendar-check"></i>
                </a> 
            </span> 
            <span class="content-header-esconder bread-span"> <?php echo $this->lang->line('roster_list'); ?> </span>
            <span style="right: 40px; position: absolute;"> 
				
				<?php if ($this->rbac->hasPrivilege('roster_shift', 'can_view')) {?>
				<a href="<?php echo base_url("admin/dutyroster/shift"); ?>" class="btn btn-primary"><i class="fa-regular fa-calendar-users"></i> <span class="content-header-esconder"><?php echo $this->lang->line('shift'); ?>  </span></a>
			<?php } if ($this->rbac->hasPrivilege('roster_list', 'can_view')) {?>
				<a href="<?php echo base_url("admin/dutyroster/rosterlist"); ?>" class="btn btn-primary"><i class="fa-regular fa-calendar-lines"></i> <span class="content-header-esconder"><?php echo $this->lang->line('roster'); ?>  </span></a>
			<?php } if ($this->rbac->hasPrivilege('roster_assign', 'can_view')) {?>
				<a href="<?php echo base_url("admin/dutyroster/rosterassign"); ?>" class="btn btn-primary"><i class="fa-regular fa-calendar-circle-user"></i> <span class="content-header-esconder"><?php echo $this->lang->line('assign_roster'); ?> </span> </a>	
			<?php } ?>
            </span>
     ...
     <form id='form111' action="<?php echo site_url('admin/dutyroster/roster_report') ?>" method="post" accept-charset="utf-8">
      ...
      <div class="box-body row">
       ...
       <div class="col-sm-6 col-md-4">
		   <div class="form-group">
		   <label>. &emsp;</label>
        <button type="submit" name="search" value="search_filter" class="btn btn-primary pull-right"><i class="fa-regular fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
			   </div>
       </div>
      </div>
     </form>
