...
<div class="content-wrapper">
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-calendars icono-menu-izquierda"></i>
            ...
            <span class="bread-span"> <?php echo $this->lang->line('appointment_list'); ?> </span>
            <span style="right: 40px; position: absolute;">
                        
            <?php if ($this->rbac->hasPrivilege('appointment', 'can_add')) {?>
            <a data-toggle="modal" data-target="#myModal" class="btn btn-primary addappointment"> <i class="fa fa-plus"></i> <?php echo $this->lang->line('add_appointment'); ?></a>
            <?php }?>
            
            <?php if ($this->rbac->hasPrivilege('doctor_wise_appointment', 'can_view')) {?>
            <a href="<?php echo base_url("admin/onlineappointment/patientschedule"); ?>" class="btn btn-primary"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('appointment_calendar'); ?></a>
            <?php }?>
            
            <?php if ($this->rbac->hasPrivilege('patient_queue', 'can_view')) {?>
            <a href="<?php echo base_url("admin/onlineappointment/patientqueue"); ?>" class="btn btn-primary"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('queue'); ?></a>
            <?php }?>
