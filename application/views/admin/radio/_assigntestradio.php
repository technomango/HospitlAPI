                ...
                <div class="table-responsive">
                    <table class="table tableover table-striped mb5 table-bordered table-hover tablefull12 tblProducts" id="tableID">
                        ...
                        <tr id="row1" class="white-space-nowrap">
                            ...
                            <td>
                                <button type="button" class="closebtn delete_row" data-row-id="1" autocomplete="off"><i class="fa-regular fa-remove"></i></button>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                 <a class="btn btn-info addplus-xs add-record mb10" data-added="0"><i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('add') ?></a>
                </div>
