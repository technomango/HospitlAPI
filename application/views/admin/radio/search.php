        ...
        <h1><i class="fa-duotone fa-solid fa-x-ray icono-menu-izquierda"></i>
            ...
            <span class="content-header-esconder mlr-10">
                <a href="<?php echo site_url('admin/radio/search') ?>"> 
                    <i class="fa-light fa-vial-virus"></i>
                </a> 
            </span> 
            <span class="content-header-esconder bread-span"> <?php echo $this->lang->line('radiology_test'); ?> </span>
            <span style="right: 40px; position: absolute;">
             <?php if ($this->rbac->hasPrivilege('radiology_test', 'can_add')) { ?>   
                                 <button  class="btn btn-primary radiology addtest" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><i class="fa-regular fa-plus"></i> <span class="content-header-esconder"><?php echo $this->lang->line('add_radiology_test'); ?></span> </button>
                            <?php } ?>               
            </span>
    </section>
    <!-- Main content -->
