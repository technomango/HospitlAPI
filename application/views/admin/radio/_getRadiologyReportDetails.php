...
if($result->radiology_report != ""){
  ?>
  <a href="<?php echo site_url('admin/radio/downloadReport/'.$result->id) ?>"><i class="fa-regular fa-download"></i> <?php echo $result->report_name; ?></a>
  <?php
}
     ?>
		</div>
...
<td>     
    ...
    <div class="input-group">
		<span class="input-group-addon" id="start-date" name="radiology_parameterdetails_<?php echo $parameter_value->id; ?>"> <?php echo $parameter_value->unit_name; ?></span>
