    ...
    <div class="col-md-12">        
        <table class="table table-striped table-bordered table-hover mb0" id="tableID">
            ...
            <tr id="row0">
                ...
                <td><button type="button"  class="closebtn delete_row"><i class="fa-regular fa-remove"></i></button></td>
            </tr>
        </table>
        <a class="btn btn-info addplus-xs btn-sm add-record mb10" data-added="0"><i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('add'); ?></a>
    </div><!--./col-md-12-->   
</div><!--./row-->               