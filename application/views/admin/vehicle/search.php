        ...
        <h1><i class="fa-duotone fa-solid fa-truck-medical icono-menu-izquierda"></i>
            ...
            <span style="right: 40px; position: absolute;">
						<?php if($this->rbac->hasPrivilege('ambulance', 'can_add')) { ?>  
                                <a data-toggle="modal" onclick="holdModal('myModal')" class="btn btn-primary addambulance"><i class="fa-regular fa-plus"></i> <span class="content-header-esconder"><?php echo $this->lang->line('add_ambulance'); ?></span></a>
                            <?php } ?>            
            </span>
