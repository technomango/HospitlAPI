...
<div class="content-wrapper">
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-bed-pulse icono-menu-izquierda"></i>
            ...
            <span class="content-header-esconder bread-span"> <?php echo $this->lang->line('ipd_in_patient'); ?> <i class="fa-regular fa-chevron-left" style="font-size: 10px; color: #7047ee;"></i> <?php echo $this->lang->line('search_patiente'); ?></span>
            <span style="right: 40px; position: absolute;">
                       <?php if ($this->rbac->hasPrivilege('ipd_patient', 'can_add')) { ?>
                                <a data-toggle="modal" onclick="holdModal('myModal')" id="addp" class="btn btn-primary addpatient"><i class="fa-regular fa-user-plus"></i>  <span class="content-header-esconder"><?php echo $this->lang->line('add_patient'); ?></span></a> 
                            <?php } ?>
                            <?php if ($this->rbac->hasPrivilege('discharged_patients', 'can_view')) { ?>
                                <a  href="<?php echo base_url() ?>admin/patient/discharged_patients" class="btn btn-secondary"><i class="fa-regular fa-user-check"></i> <span class="content-header-esconder"><?php echo $this->lang->line('discharged_patient'); ?></span></a> 
                            <?php } ?>                    
            </span>
                    ...
                    <div class="col-sm-4 col-xs-4">
                        <div class="form-group15">
                            <?php if ($this->rbac->hasPrivilege('patient', 'can_add')) { ?>
                                <a data-toggle="modal" id="addpip" onclick="holdModal('myModalpa')" class="modalbtnpatient btn btn-primary"><i class="fa-regular fa-plus"></i>  <span><?php echo $this->lang->line('new_patient'); ?></span></a> 
                            <?php } ?> 
                        </div>
                    </div>
                </div><!--./row--> 
...
<?php } ?>
                                    ...
                                    <div class="col-sm-6" id="antenatal_div" style="display:none">
                                        <div class="form-group pt-lg-28">
                                            <label>
                                            <input type="checkbox" class="align-top" name="is_for_antenatal" id="is_for_antenatal" value="1" > Embarazo</label>
                                        </div>
                                    </div>
                                </div><!--./row-->    
                            </div><!--./col-md-4-->
