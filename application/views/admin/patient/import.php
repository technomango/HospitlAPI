	...
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-bed-pulse icono-menu-izquierda"></i>
            ...
            <span class="content-header-esconder mlr-10">
                <a href="<?php echo site_url('admin/patient/import') ?>"> 
                    <i class="fa-light fa-users"></i>
                </a> 
            </span> 
            <span class="content-header-esconder bread-span"> <?php echo $this->lang->line('import_patients'); ?></span>
            <span style="right: 40px; position: absolute;">
						<?php if ($this->rbac->hasPrivilege('patient_import', 'can_view')) { ?>
                                <a href="<?php echo site_url('admin/patient/exportformat') ?>">
                                    <button class="btn btn-primary"><i class="fa-regular fa-download"></i> <span class="content-header-esconder"><?php echo $this->lang->line('download_sample_data'); ?></span></button>
                                </a>
                            <?php } ?>                    
            </span>
            ...
            <div class="col-md-12">
                <div class="box box-primary around20">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('import_patients'); ?></h3>
                        ...
                        <div class="box-body pt20">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 pt20">
                                    <button type="submit" class="btn btn-info pull-right"><i class="fa-regular fa-upload"></i> <?php echo $this->lang->line('import'); ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
