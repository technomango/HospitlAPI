...
<div class="content-wrapper" >
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-stethoscope icono-menu-izquierda"></i>
             <?php echo $this->lang->line('ipd_in_patient'); ?></h1>  
            <span class="mlr-10">
                <a href="<?php echo site_url('admin/patient/search') ?>"> 
                    <i class="fa-light fa-users"></i>
                </a> 
            </span> 
            <span class="bread-span"> <?php echo $this->lang->line('patient_profile'); ?> <i class="fa-regular fa-chevron-right" style="font-size: 10px; color: #7047ee;"></i> <?php echo $result['patient_name']; ?></span>
            ...
            <div class="box border0 mb0">
                    <div class="nav-tabs-custom border0 mb0" id="tabs" > 
                        <ul class="nav nav-tabs border-0 navlistscroll" role="tablist">
                            <li class="active"><a href="#overview" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-file-spreadsheet"></i> <?php echo $this->lang->line('overview'); ?></a></li>
                            <?php if ($this->rbac->hasPrivilege('nurse_note', 'can_view')) { ?>
                                <li >
                                    <a href="#nurse_note" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-notes"></i> <?php echo $this->lang->line('nurse_notes'); ?></a>
                                </li>
                            <?php } ?>
							<?php if ($this->rbac->hasPrivilege('ipd_vitals', 'can_view')) {?>
                            <li><a href="#vitals" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-heart-pulse"></i> <?php echo $this->lang->line('vitals'); ?></a></li>
                            <?php } ?> 
                            <?php if ($this->rbac->hasPrivilege('ipd_medication', 'can_view')) {  ?>
                                <li>
                                    <a href="#medication" role="tab" class="medication" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-prescription-bottle-pill" aria-hidden="true"></i> <?php echo $this->lang->line("medication"); ?></a>
                                </li>
                            <?php } ?>
                            <?php if ($this->rbac->hasPrivilege('ipd_prescription', 'can_view')) { ?>
                                <li>
                                    <a href="#prescription" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-file-prescription"></i> <?php echo $this->lang->line('prescription'); ?></a>
                                </li>
                            <?php } ?> 
                            <?php if ($this->rbac->hasPrivilege('consultant_register', 'can_view')) { ?>
                                <li class="">
                                    <a href="#consultant_register" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-user-doctor"></i> <?php echo $this->lang->line('consultant_register'); ?></a>
                                </li>
                            <?php } ?>
                            <?php if ($this->rbac->hasPrivilege('ipd_lab_investigation', 'can_view')) { ?>
                                <li>
                                    <a href="#labinvestigation" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-flask"></i> <?php echo $this->lang->line('lab_investigation'); ?></a>
                                </li>
                            <?php } ?>
                            <?php if ($this->rbac->hasPrivilege('ipd_operation_theatre', 'can_view')) {  ?>
                                 <li>
                                    <a href="#operationtheatre" role="tab" class="operationtheatre" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-user-nurse" aria-hidden="true"></i> <?php echo $this->lang->line("operations"); ?></a>                                    
                                </li>
                            <?php } ?> 
                            <?php if ($this->rbac->hasPrivilege('charges', 'can_view')) { ?>
                                <li>
                                    <a href="#charges" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-file-invoice-dollar"></i> <?php echo $this->lang->line('charges'); ?></a>
                                </li>
                            <?php } ?>
                            <?php if ($this->rbac->hasPrivilege('payment', 'can_view')) { ?>
                                <li>
                                    <a href="#payment" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-money-check-dollar"></i> <?php echo $this->lang->line('payments'); ?></a>
                                </li>
                            <?php } ?>
                            <?php if ($this->module_lib->hasActive('live_consultation')) { if ($this->rbac->hasPrivilege('ipd_live_consultation', 'can_view')) {  ?>
                                <li>
                                    <a href="#live_consult" role="tab" class="live_consult" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-screen-users ftlayer"></i> <?php echo $this->lang->line('live_consultation'); ?></a>
                                </li> 
                            <?php } } ?>
                            <?php if ($this->rbac->hasPrivilege('bed_history', 'can_view')) {  ?>
								<li>
									<a href="#bed_history" role="tab" class="bed_history" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-procedures"></i> <?php echo $this->lang->line("bed_history"); ?></a>
								</li>
                            <?php } ?>                                 
                            <?php if ($this->rbac->hasPrivilege('ipd_timeline', 'can_view')) { ?>
                                <li>
                                    <a href="#timeline" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-calendar-check"></i> <?php echo $this->lang->line('timeline'); ?></a>
                                </li>
                            <?php } ?> 
                            <?php if ($this->rbac->hasPrivilege('ipd_treatment_history', 'can_view')) {?>
                                <li>
                                    <a href="#treatment_history" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa-regular fa-rectangle-history-circle-user"></i> <?php echo $this->lang->line('treatment_history'); ?></a>
                                </li>
                            <?php } ?>                            
                            ...
                            <?php                               
                                if($result['is_active'] != 'no') { if ($result['ipd_discharge'] != 'yes') {if ($this->rbac->hasPrivilege('ipd_patient', 'can_edit')) {
                                  ...
                                  if ($this->rbac->hasPrivilege('ipd_patient_discharge', 'can_view')) { ?>
                                     <a class="patient_discharge" href="#" data-toggle="tooltip" title="<?php echo $this->lang->line('patient_discharge'); ?>"><i class="fa-regular fa-house-medical-circle-xmark"></i> 
                                    </a>                                    
                                    <?php }                                         
                            ...
                            ?>                         
										...
										<div class="box-header with-border perfil-usuario">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 around20">
                                                ...
                                                <table class="table table-bordered around20 pb0">
                                                   <tr>
                                                        <td class="text-left letra16" width="50%"><i class="fa-regular fa-venus-mars iconos-paciente" data-toggle="tooltip" data-placement="top" title="" data-original-title="Género"></i> <?php echo $this->lang->line('gender'); ?> <?php echo $this->lang->line(strtolower($result['gender'])); ?></td>
                                                        <td class="text-left letra16" width="50%"><i class="fa-regular fa-cake iconos-paciente" data-toggle="tooltip" data-placement="top" title="" data-original-title="Age"></i> <?php echo $this->customlib->getPatientAge($result['age'],$result['month'],$result['day'])." (".$this->lang->line('as_of_date').' '.$this->customlib->YYYYMMDDTodateFormat($result['as_of_date']).")"; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-left letra16" width="50%"><i class="fa-regular fa-user-group-simple iconos-paciente" data-toggle="tooltip" data-placement="top" title="" data-original-title="Encargado"></i> <?php echo $result['guardian_name']; ?></td>
                                                        <td class="text-left letra16" width="50%"><i class="fa-regular fa-phone iconos-paciente" data-toggle="tooltip" data-placement="top" title="" data-original-title="phone"></i> <?php echo $result['mobileno']; ?></td>
                                                    </tr>  
                                                                                                     
                                                    <?php 
                                                    if (file_exists("./uploads/patient_id_card/barcodes/" . $patient_id . ".png")) { ?>
                                                    <tr>
                                                        <td class="text-left letra16" width="50%"><i class="fa-regular fa-barcode iconos-paciente" data-toggle="tooltip" data-placement="top" title="" data-original-title="Género"></i> <img src="<?php echo base_url("./uploads/patient_id_card/barcodes/" . $patient_id . ".png"); ?>" width="100" height="30"  /></td>
                                                        <?php }  ?>
                                                    <?php 
                                                    if (file_exists("./uploads/patient_id_card/qrcode/" . $patient_id. ".png")) { ?>
														<td class="text-left letra16" width="50%"><i class="fa-regular fa-qrcode iconos-paciente" data-toggle="tooltip" data-placement="top" title="" data-original-title="Género"></i> <img class="max-h-50" src="<?php echo base_url("./uploads/patient_id_card/qrcode/" . $patient_id. ".png"); ?>" width="70" height="70" />
                                                        </td>
														<?php }  ?> 
                                                    </tr>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 around20 pt0">
                                                <div class="align-content-center pt0">
                                                    <table class="table table-bordered around20 pb0">
                                                         <tr>
                                                            <td class="text-left letra16" width="50%"><i class="fa-regular fa-hashtag iconos-paciente" data-toggle="tooltip" data-placement="top" title="" data-original-title="ID Consulta Externa"></i> <?php echo $result['case_reference_id']?></td>
                                                            <td class="text-left letra16" width="50%"><i class="fa-regular fa-hashtag iconos-paciente" data-toggle="tooltip" data-placement="top" title="" data-original-title="Caso"></i> <?php echo $this->customlib->getSessionPrefixByType('ipd_no').$ipdid; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-left letra16" width="50%"><i class="fa-regular fa-calendar-check iconos-paciente" data-toggle="tooltip" data-placement="top" title="" data-original-title="Fecha de Admisión"></i>  <?php echo $this->customlib->YYYYMMDDHisTodateFormat($result['date'], $time_format); ?></td>
                                                            <td class="text-left letra16" width="50%"><i class="fa-regular fa-bed iconos-paciente" data-toggle="tooltip" data-placement="top" title="" data-original-title="Detalles de la Cama"></i>  <?php echo $result['bed_name'] . " - " . $result['bedgroup_name'] . " - " . $result['floor_name'] ?></td>
                                                        </tr>
                                                    </table>
                                                </div>    
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12">
												<h4><i class="fa-regular fa-credit-card rtl-ms-0-7-5"></i> <?php echo $this->lang->line('credit_limit'); ?></h4>
                                    ...
                                    <div class="box-header mb10 pl-0">
                                        ...
                                        <h4><i class="fa-regular fa-stethoscope"></i> <?php echo $this->lang->line('doctor'); ?></h4>
                                           ...
                                           <div class="pull-right">
                                              <div class="editviewdelete-icon pt0">                                              
                                                <?php if($is_discharge) {
                                              ...
                                              foreach ($doctors_ipd as $dkey => $dvalue) {?>
                                                ...
                                                <div class="media-body">
                                                    <?php if($this->rbac->hasPrivilege('ipd_patient', 'can_delete')){    ?>                                                    
                                                        <a onclick="delete_record('<?php echo base_url(); ?>admin/patient/delete_doctors/<?php echo $result['patient_id']; ?>/<?php echo $ipdid; ?>/<?php echo $dvalue['id']; ?>', '<?php echo $this->lang->line('delete_message'); ?>')" data-original-title="<?php echo $this->lang->line('remove'); ?>" class="btn btn-danger pull-right text-danger" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa-regular fa-square-minus"></i></a>
                                                    <?php } ?>                                                    
                                        ...
                                        <?php } ?>    
                                           ...
                                           <hr class="hr-panel-heading hr-10">
                                    <h4><i class="fa-regular fa-notes rtl-ms-0-7-5"></i> <?php echo $this->lang->line('nurse_notes'); ?></h4> 
                                           
                                           
                                        <div class="timeline-header no-border pb1 pt20">
                                                ...
                                                <?php echo $this->customlib->YYYYMMDDHisTodateFormat($nurse_note[$i]['date'],$this->customlib->getHospitalTimeFormat()); ?>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="timeline-item">
                                                            <h3 class="timeline-header"> <?php echo $nurse_note[$i]['name'].' '.$nurse_note[$i]['surname']." ( ".$nurse_note[$i]['employee_id']." )" ; ?> </h3>                                                            
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="timeline-item">
                                                            ...
                                                            <?php if (!empty($timeline_list[$i]["document"])) { ?>
                                                                <span class="times"><a class="defaults-c text-right" data-toggle="tooltip" title="" href="<?php echo base_url() . "admin/timeline/download_patient_timeline/" . $timeline_list[$i]["id"] . "/" . $timeline_list[$i]["document"] ?>" data-original-title="<?php echo $this->lang->line('download'); ?>"><i class="fa-duotone fa-solid fa-download" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i></a></span>
                                                            <?php } ?>
                                                            <h3 class="timeline-header"> <?php echo $timeline_list[$i]['title']; ?> </h3>
                                                            <div class="timeline-body">
                                   ...
                                   <?php } ?>                       
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 mtop5">
                                                       <div class="topprograssstart">
                                                            <h5 class="mt5"><?php echo $this->lang->line('ipd'); ?><span class="pull-right"><i class="fa-duotone fa-solid fa-bed-pulse" style="--fa-primary-color: #2e37a4;--fa-secondary-color: #2e37a4;font-size: 24px;padding: 12px;padding-top: 0;"></i></span>
                                                            </h5>
                                           ...
                                           <div class="col-md-6 project-progress-bars tarjeta-graficos-detalles">
                                                <div class="row">
                                                    <div class="col-md-12 mtop5">
                                                        <div class="topprograssstart">
                                                            <h5 class="mt5"><?php echo $this->lang->line('pharmacy'); ?><span class="pull-right"><i class="fa-duotone fa-solid fa-prescription-bottle-pill" style="--fa-primary-color: #2e37a4;--fa-secondary-color: #2e37a4;font-size: 24px;padding: 12px;padding-top: 0;"></i></span>
                                                            </h5>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 project-progress-bars tarjeta-graficos-detalles">
                                                <div class="row">
                                                    <div class="col-md-12 mtop5">
                                                       <div class="topprograssstart">
                                                            <h5 class="mt5"><?php echo $this->lang->line('pathology'); ?><span class="pull-right"><i class="fa-duotone fa-solid fa-flask" style="--fa-primary-color: #2e37a4;--fa-secondary-color: #2e37a4;font-size: 24px;padding: 12px;padding-top: 0;"></i></span>
                                                            </h5>
                                           ...
                                           <div class="col-md-6 project-progress-bars tarjeta-graficos-detalles">
                                                <div class="row">
                                                    <div class="col-md-12 mtop5">
                                                        <div class="topprograssstart">
                                                            <h5 class="mt5"><?php echo $this->lang->line('radiology'); ?><span class="pull-right"><i class="fa-duotone fa-solid fa-microscope" style="--fa-primary-color: #2e37a4;--fa-secondary-color: #2e37a4;font-size: 24px;padding: 12px;padding-top: 0;"></i></span>
                                                            </h5>
                                        ...
                                        <?php if ($this->module_lib->hasActive('blood_bank')) { ?>
                                            <div class="col-md-6 project-progress-bars tarjeta-graficos-detalles">
                                                <div class="row">
                                                    <div class="col-md-12 mtop5">
                                                       <div class="topprograssstart">
                                                            <h5 class="mt5"><?php echo $this->lang->line('blood_bank'); ?><span class="pull-right"><i class="fa-duotone fa-solid fa-tint" style="--fa-primary-color: #2e37a4;--fa-secondary-color: #2e37a4;font-size: 24px;padding: 12px;padding-top: 0;"></i></span>
                                                            </h5>
                                           ...
                                           <div class="col-md-6 project-progress-bars tarjeta-graficos-detalles">
                                                <div class="row">
                                                    <div class="col-md-12 mtop5">
                                                        <div class="topprograssstart">
                                                            <h5 class="mt5"><?php echo $this->lang->line('ambulance'); ?><span class="pull-right"><i class="fa-duotone fa-solid fa-ambulance" style="--fa-primary-color: #2e37a4;--fa-secondary-color: #2e37a4;font-size: 24px;padding: 12px;padding-top: 0;"></i></span>
                                                            </h5>
                                    ...
                                    <hr class="hr-panel-heading hr-10">
                                         <div class="box-header pl-0">
                                           <h4><i class="fa-regular fa-file-prescription" aria-hidden="true"></i> <?php echo $this->lang->line('prescription'); ?></h4>
                                      </div>
                                          <div class="box-header pl-0">
                                             <div class="table-responsive">   
                                                <?php  if (!empty($prescription_detail)) { ?>
                                    ...
                                    <hr class="hr-panel-heading hr-10">    
                                         <div class="box-header pl-0">
                                           <h4><i class="fa-regular fa-user-doctor" aria-hidden="true"></i> <?php echo $this->lang->line('consultant_register'); ?></h4>
                                      </div>
                                           <div class="box-header pl-0">
                                             <div class="table-responsive">
                                                <?php 
...
<?php } ?>
                                ...
                                <?php } ?>
                                         ...
                                         <div class="box-header mb10 pl-0">
                                           <h4><i class="fa-regular fa-money-check-dollar" aria-hidden="true"></i> <?php echo $this->lang->line('payment'); ?></h4>
                                        </div>
                                         <div class="box-header mb10 pl-0">
                                             <div class="table-responsive">
                                ...
                                <?php } ?>
                                         ...
                                         <div class="box-header mb10 pl-0">
                                          <h4><i class="fa-regular fa-screen-users" aria-hidden="true"></i> <?php echo $this->lang->line('live_consultation'); ?></h4>
                                        </div>
                                        <div class="box-header mb10 pl-0">
                                            <div class="table-responsive">
                                                <?php                                             
                                ...
                                <?php } ?>
                                         ...
                                         <div class="box-header mb10 pl-0">
                                           <h4><i class="fa-regular fa-rectangle-history-circle-user" aria-hidden="true"></i> <?php echo $this->lang->line('treatment_history'); ?></h4>
                                        </div>
                                        <div class="box-header mb10 pl-0">
                                            <div class="table-responsive">
                             ...
                             <?php } ?>
                                         ...
                                         <div class="box-header mb10 pl-0">
                                            <h4><i class="fa-regular fa-procedures" aria-hidden="true"></i> <?php echo $this->lang->line('bed_history'); ?></h4>
                                        </div>
                                        <div class="box-header mb10 pl-0">
                                            <div class="table-responsive">
                                                <?php 
                            ...
                            <div class="tab-pane tab-content-height " id="nurse_note">
								<div class="box-tab-header">
                                        <h3 class="box-tab-title"><i class="fa-duotone fa-solid fa-notes" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i> <?php echo $this->lang->line('nurse_notes'); ?></h3>
                                        <div class="box-tab-tools">
                                            <?php
                                    if ($this->rbac->hasPrivilege('nurse_note', 'can_add')) {
                                        if($is_discharge) {
                                            ?>
                                                <a href="#" class="btn btn-primary dropdown-toggle addnursenote" onclick="holdModal('add_nurse_note')" data-toggle="modal"><i class="fas fa-plus"></i> <?php echo $this->lang->line('add_nurse_note') ; ?></a>
                                            <?php
                                        }
                                    }
                                    ?>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="timeline-item">
                                                            <?php if($is_discharge) { if ($this->rbac->hasPrivilege('nurse_note', 'can_delete')) { ?>
                                                                ...
                                                                <a class="defaults-c text-right"  data-toggle="tooltip" title="" onclick="delete_record('<?php echo base_url(); ?>admin/patient/deleteIpdnursenote/<?php echo $value['id']; ?>/<?php echo $value['ipd_id']; ?>', '<?php echo $this->lang->line('delete_message'); ?>')" data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                                    <i class="fa-duotone fa-solid fa-trash" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i>
                                                                </a>
                                                                </span>
                                                                <?php } } ?>
                                                                ...
                                                                <i class="fa-duotone fa-solid fa-comment" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i>
                                                                </a>
                                                                </span>
                                                                <span class="times">
                                                            ...
                                                            <h3 class="timeline-header"> <?php echo $value['name'].' '.$value['surname']." ( ".$value['employee_id']." )" ; ?> </h3>
                                                            <div class="timeline-body">
                        ...
                        <div class="tab-pane" id="vitals">
                            <div class="box-tab-header">
                                ...
                                <a data-toggle="modal" onclick="holdModal('vitalModal')" id="add_vital_modal" class="btn btn-primary vital"><i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('add_vital'); ?> </a>
                                <?php } ?> 
                                        </div>    
                                   </div><!--./box-tab-header--> 
                        ...
                        <?php } ?>
                            ...
                            <div class="tab-pane tab-content-height" id="consultant_register">
                                <div class="box-tab-header">
                                        <h3 class="box-tab-title"><i class="fa-duotone fa-solid fa-user-doctor" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i> <?php echo $this->lang->line("consultant_register"); ?></h3>
                                        <div class="box-tab-tools">
                                        <?php
                                            if ($this->rbac->hasPrivilege('consultant_register', 'can_add')) {
                                               if($is_discharge) { 
                                                    ?>
                                                        <a href="#" class="btn btn-primary dropdown-toggle addconsultant" onclick="holdModal('add_instruction')" data-toggle="modal"><i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('add_consultant_register'); ?></a>
                                                    <?php
                                                }
                                            }
                                        ?>
        ...
        <td><?php echo $this->customlib->YYYYMMDDHisTodateFormat($consultant_value['date'],$this->customlib->getHospitalTimeFormat()); ?></td>
                            ...
                            <?php if ($this->rbac->hasPrivilege('ipd_prescription ', 'can_view')) { ?>
                                <div class="tab-pane tab-content-height" id="prescription">
									<div class="box-tab-header">
                                        <h3 class="box-tab-title"><i class="fa-duotone fa-solid fa-file-prescription" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i> <?php echo $this->lang->line("prescription"); ?></h3>
                                        <div class="box-tab-tools">
                                        <?php if ($this->rbac->hasPrivilege('ipd_prescription ', 'can_add')) {
                                                if($is_discharge){
                                             ?>
                                                <a href="#" class="btn btn-primary dropdown-toggle addprescription"  data-toggle="modal"><i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('add_prescription'); ?></a>
                                            <?php }} ?>
                                        </div>    
                                   </div><!--./box-tab-header--> 
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered  example">
                                            <thead>
                                            <th><?php echo $this->lang->line('ipd_no_pres'); ?></th>
                                            <th><?php echo $this->lang->line('date'); ?></th>
                                                ...
                                                if (!empty($prescription_detail)) {
                                                    foreach ($prescription_detail as $prescription_key => $prescription_value) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            ?>
                                                            <td class="text-right">
                                                                <a href="#prescription" class="" onclick="view_prescription('<?php echo $prescription_value["id"] ?>', '<?php echo $prescription_value["ipd_id"] ?>','<?php echo $result["ipd_discharge"]?>')"   data-toggle="tooltip" title="<?php echo $this->lang->line('view') . " " . $this->lang->line('prescription'); ?>">
                        ...
                        <?php } ?>  
                          ...
                          <?php if ($this->rbac->hasPrivilege('ipd_timeline', 'can_view')) { ?>  
                            <div class="tab-pane tab-content-height" id="timeline">
                                <div class="box-tab-header">
                                        <h3 class="box-tab-title"><i class="fa-duotone fa-solid fa-calendar-check" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i> <?php echo $this->lang->line("timeline"); ?></h3>
                                        <div class="box-tab-tools">
                                        <?php if ($result['ipd_discharge'] != 'yes') { if ($this->rbac->hasPrivilege('ipd_timeline', 'can_add')) { ?>
                                         <a href="#" class="btn btn-primary dropdown-toggle addtimeline" onclick="holdModal('myTimelineModal')" data-toggle='modal'><i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('add_timeline'); ?></a>
                                          <?php } } ?>
                                        </div>    
                                   </div><!--./box-tab-header--> 
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="timeline-item">
                                                            <?php if($is_discharge) { if ($this->rbac->hasPrivilege('ipd_timeline', 'can_delete')) { 
                                                             ...
                                                             ?>
                                                                <span class="times"><a class="defaults-c text-right" data-toggle="tooltip" title="" onclick="delete_timeline('<?php echo $value['id']; ?>')" data-original-title="<?php echo $this->lang->line('delete'); ?>"><i class="fa-duotone fa-solid fa-trash-can" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i></a></span>
                                                                    <?php }}} ?>
                                                                    <?php if($is_discharge) {
                                                                    if ($this->rbac->hasPrivilege('ipd_timeline', 'can_edit')) {
                                                                    if ($value['generated_users_type'] != 'patient') {
                                                                ?><span class="times"><a onclick="editTimeline('<?php echo $value['id']; ?>')" class="defaults-c text-right" data-toggle="tooltip" title=""  data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                                        <i class="fa-duotone fa-solid fa-pen-to-square" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i>
                                                                    </a></span> 

                                                            <?php }}}?>
                                                            <?php if (!empty($value["document"])) { ?>
                                                                <span class="times"><a class="defaults-c text-right" data-toggle="tooltip" title="" href="<?php echo base_url() . "admin/timeline/download_patient_timeline/" . $value["id"] . "/" . $value["document"] ?>" data-original-title="<?php echo $this->lang->line('download'); ?>"><i class="fa-duotone fa-solid fa-cloud-arrow-down" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i></a></span>
                                                            <?php } ?>
                            ...
                            <?php if ($this->rbac->hasPrivilege('bed_history', 'can_view')) {  ?>
                                <div class="tab-pane tab-content-height" id="bed_history">
                                    <div class="box-tab-header">
                                        <h3 class="box-tab-title"><i class="fa-duotone fa-solid fa-procedures" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i> <?php echo $this->lang->line("bed_history"); ?></h3>
                                ...
                                <div class="tab-pane tab-content-height" id="medication">
                                    <div class="box-tab-header">
                                        <h3 class="box-tab-title"><i class="fa-duotone fa-solid fa-prescription-bottle-pill" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i> <?php echo $this->lang->line("medication"); ?></h3>
                                        <div class="box-tab-tools">
                                        ...
                                        <table class="table table-striped table-bordered  mb0">
                                          <thead>
                                            ...
                                            for ($x = 1; $x <= $dosage_count; $x++) { ?>
                                              ...
                                              <th class="table_inner_tdwidth" width="50%"><?php echo $this->lang->line("dose").' '.$x  ;?></th>
                                           <?php }
                                            ?> 
                                    </thead>
                                    <tbody> 
                        ...
                        <?php if ($this->rbac->hasPrivilege('ipd_operation_theatre', 'can_view')) {  ?>
                            <div class="tab-pane tab-content-height" id="operationtheatre">
                                <div class="box-tab-header">
                                        <h3 class="box-tab-title"><i class="fa-duotone fa-solid fa-scalpel-line-dashed" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i> <?php echo $this->lang->line("operations"); ?></h3>
                                        <div class="box-tab-tools">
                                         <?php 
                                            if($is_discharge) {
                                        ...
                                        if (!empty($operation_theatre)) {
                                            foreach ($operation_theatre as $ot_key => $ot_value) {
                                                ...
                                                <tr>    
                                                    ...
                                                    ?>
                                                    <td class="text-right">
                                                        <a href='#' data-toggle='tooltip' title="<?php echo $this->lang->line('show'); ?>" class='btn btn-default btn-xs'   data-target='#view_ot_modal' onclick='viewdetail("<?php echo $ot_value['id']; ?>")'>  <i class='fa-regular fa-eye'></i> </a>
                                                        <?php if($is_discharge) { 
                       ...
                       <?php } if ($this->rbac->hasPrivilege('charges', 'can_view')) { ?>     
                            <div class="tab-pane tab-content-height" id="charges">
                                <div class="box-tab-header">
                                        <h3 class="box-tab-title"><i class="fa-duotone fa-solid fa-file-invoice-dollar" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i> <?php echo $this->lang->line("charges"); ?></h3>
                                        <div class="box-tab-tools">
                                        <?php
                                            if ($this->rbac->hasPrivilege('charges', 'can_add')) {
                                               if($is_discharge) {
                                                    ?>
                                                        <a href="#" class="btn btn-primary dropdown-toggle addcharges" onclick="holdModal('myChargesModal')" data-toggle='modal'><i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('add_charges'); ?></a>
                                                    <?php
                                                }
                                            }
                                            ?> 
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered  example">
                                        ...
                                        <th><?php echo $this->lang->line('charge_category'); ?></th>
                                         <th><?php echo $this->lang->line('qty'); ?></th>
                                        <th class="text-right"><?php echo $this->lang->line('standard_charge'); ?> </th>
                                        <th class="text-right"><?php echo $this->lang->line('applied_charge'); ?></th>
                                        <th class="text-right"><?php echo $this->lang->line('tpa_charge');?></th>
                                                ...
                                                $tax_amount = calculatePercent(($charge['apply_charge']-$discount_amount),$charge['tax']);
                                                 $taxamount = amountFormat($tax_amount);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right"><?php echo $currency_symbol.number_format($charge["standard_charge"], 2) ?></td>
                                                        <td class="text-right"><?php echo $currency_symbol.number_format($charge["apply_charge"], 2) ?></td>
                                                        <td class="text-right"><?php echo $currency_symbol.number_format($charge["tpa_charge"], 2) ?></td>
                                                        <td class="text-right"><?php echo $currency_symbol.number_format($charge["discount_amount"], 2)." (".$charge["discount_percentage"]."%) "; ?></td>
                                                        <td class="text-right"><?php echo $currency_symbol.number_format($charge["taxamount"], 2)." (".$charge["tax"]."%) "; ?></td>                                             
                                                        <td class="text-right"><?php echo $currency_symbol.number_format($charge["amount"], 2) ?></td>
                                                        ...
                                                        <?php if($is_discharge) { if ($this->rbac->hasPrivilege('charges', 'can_edit')) { ?>
                                                           <a href='javascript:void(0);' class='btn btn-default btn-xs edit_charge' data-loading-text="<?php echo $this->lang->line('please_wait'); ?>" data-toggle='tooltip' data-record-id='<?php echo $charge['id']; ?>'  title="<?php echo  $this->lang->line('edit')?>"><i class='fa-regular fa-pen-to-square'></i></a>
...
<?php } ?>                                        
                           ...
                           if ($this->rbac->hasPrivilege('payment', 'can_view')) { ?> 
                            <div class="tab-pane tab-content-height" id="payment">
                                <div class="box-tab-header">
                                        <h3 class="box-tab-title"><i class="fa-duotone fa-solid fa-money-check-dollar" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i> <?php echo $this->lang->line("payments"); ?></h3>
                                        <div class="box-tab-tools">
                                        <?php
                                            if ($this->rbac->hasPrivilege('payment', 'can_add')) {
                                                    ?>
                                                        <a href="#" class="btn btn-primary dropdown-toggle addpayment" onclick="addpaymentModal()" data-toggle='modal'><i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('add_payment'); ?></a>
                                                    <?php
                                            }
                                            ?>
                                        </div>    
    ...
    <?php
         ...
         ?>         
            ...
            <a href="javascript:void(0)" class="btn btn-default btn-xs print_trans" data-record-id="<?php echo $payment['id'] ?>" data-loading-text="<?php echo $this->lang->line('please_wait'); ?>" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('print'); ?>"><i class="fa-regular fa-print"></i></a>
                            ...
                            <div class="row">                            
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="comment" id="ecomment" style="height:120px" class="form-control"></textarea>
                                    </div> 
                                </div>
                    ...
                    <div class="ptt10">
                        <div class="row">                            
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('comment') ?> <small class="req"> *</small> </label>
                                    <textarea name="comment_staff" id="comment_staff" style="height:120px" class="form-control"></textarea>
                                </div> 
                            </div>
                        </div>
                    </div>
        ...
        <input type="text" value="" id="date" name="date" class="form-control datetime">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="ot_remark" id="ot_remark" class="form-control textarea-height-60" ></textarea> 
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                     ...
                                     <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('remark'); ?></label>
                                                <textarea name="eot_remark" id="eot_remark" class="form-control textarea-height-60" ></textarea> 
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea  name="remark" id="remark" class="form-control textarea-height-60"></textarea>                                        
                                        </div>
                                    </div>
                                </div>
                        </div>                   
                        ...
                        <input type="hidden" name="medication_id" id="medication_id" value="">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line("remarks"); ?></label> 
                                        <textarea  name="remark" id="medicine_dosage_remark" class="form-control textarea-height-60"></textarea>
                        ...
                        <div class="row">                     
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="row ptt10">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('price') . " (" . $currency_symbol . ")" ?></label>
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('quantity'); ?></label><small class="req"> *</small> 
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5 mb10">
                                            <table class="printablea4">
                                                <tr>
                                                    <th class="precios-th" width="40%"><?php echo $this->lang->line('total'); ?></th>
                                                    <td width="60%" colspan="2" class="text-right ipdbilltable">
                                                        <div class="input-group">
														  <div class="input-group-addon-2" style="left: 135px; position: absolute; top: 6px;">
															<span>Q. </span>
														  </div>
														<input type="text" placeholder="Total" value="0" name="apply_charge" id="apply_charge" style="width: 38%; float: right; right: -25px;" class="form-control total" readonly />
															</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="precios-th" width="40%"><?php echo $this->lang->line('discount'); ?></th>
                                                    <td class="text-right ipdbilltable" width="30%"><div class="input-group">
														  <div class="input-group-addon-2" style="left: 0px; position: absolute; top: 6px;">
															<span>% </span>
														  </div>
                                                    			<input type="text"  value="0" placeholder="<?php echo $this->lang->line('discount_percentage'); ?>" name="discount_percentage" id="discount_percentage_add_charge" class="form-control discount_percentage_add_charge"  style="width: 60%; float: left;font-size: 16px; left: 20px;"/>
															</div>	
													</td>
                                                    <td class="text-right ipdbilltable" width="30%">
														<div class="input-group">
														  <div class="input-group-addon-2" style="left: 6px; position: absolute; top: 6px;">
															<span>Q. </span>
														  </div>
														<input type="text" placeholder="<?php echo $this->lang->line('discount_percentage'); ?>" name="discount_percentage_amount" value="0" id="discount_percentage_amount" style="width: 68%; float: left; left: 30px;" class="form-control discount_percentage_amount" readonly/>
													</div>
													</td>
                                                </tr>
                                                <tr>
                                                    <th class="precios-th" width="40%"><?php echo $this->lang->line('tax'); ?></th>
                                                    <td class="text-right ipdbilltable" width="30%">
														<div class="input-group">
                                                        <div class="input-group-addon-2" style="left: 0px; position: absolute; top: 6px;">
															<span>% </span>
															</div>
                                                        	<input type="text" placeholder="" name="charge_tax" id="charge_tax" class="form-control charge_tax" readonly style="width: 60%; float: left;font-size: 16px; left: 20px;"/>
														</div>
                                                    </td>
                                                    <td class="text-right ipdbilltable" width="30%">
														<div class="input-group">
														  <div class="input-group-addon-2" style="left: 6px; position: absolute; top: 6px;">
                                                        	...
                                                        	<input type="text" placeholder="Tax" name="tax" value="0" id="tax" style="width: 68%; float: left; left: 30px;" class="form-control tax" readonly/>
														</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="precios-th" width="40%"><?php echo $this->lang->line('net_amount'); ?></th>
                                                    <td width="60%" colspan="2" class="text-right ipdbilltable">
														<div class="input-group">
														  <div class="input-group-addon-2" style="left: 135px; position: absolute; top: 6px;">
															<span>Q. </span>
														  </div>
                                                        	<input type="text" placeholder="Net Amount" value="0" name="amount" id="final_amount" style="width: 38%; float: right; right: -25px;" class="form-control net_amount" readonly/>
														</div>
                                                    </td>
                                                </tr>
                                            </table>                                            
        ...
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
             <form id="edit_charges" accept-charset="utf-8" method="post">  
                <div class="row">                   
                   <div class="col-lg-9 col-md-5 col-sm-11">
                ...
                <div class="scroll-area">                                            
                    <div class="modal-body pb0 ptt10">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('instructions'); ?> <small class="req"> *</small> </label>
                                        <textarea name="instruction" rows="5"class="form-control textarea-height-60"></textarea>
                                    </div> 
                                </div>                                
                                <div class="">
                    ...
                    <div class="modal-body pt0 pb0">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('instructions'); ?> <small class="req"> *</small> </label>
                                        <textarea name="instruction" id="ecinstruction" rows="5" class="form-control textarea-height-60"></textarea>
                                    </div> 
                                </div>                                
                    ...
                    <div class="modal-body pb0 ptt10">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('comment'); ?> <small class="req"> *</small> </label>
                                        <textarea name="comment" style="height:120px" class="form-control"></textarea>
                                    </div> 
                                </div>                                
                                <div class="">
                        ...
                        <div class="row">
                           <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control textarea-height-60"   name="general_remark" id="general_remark"></textarea>
            ...
            $.ajax({ 
                ...
                success: function (res) {
                    if (res.status == "fail") {
                        ...
                        var data=res.data;
                        var row_id=makeid(8);  
                        var charge='<tr id="'+row_id+'"><td>'+data.date+'<input type="hidden" name="pre_date[]" value="'+data.date+'"></td><td>'+data.charge_type_name+'</td><td>'+data.charge_category+'</td><td>'+data.charge_name+'<input type="hidden" name="pre_tax_percentage[]" value="'+data.tax_percentage+'"><input type="hidden" name="pre_charge_id[]" value="'+data.charge_id+'"><br><h6>'+data.note+'<input type="hidden" name="pre_note[]" value="'+data.note+'"></h6></td><td class="text-center">'+data.qty+'<input type="hidden" name="pre_qty[]" value="'+data.qty+'"></td><td class="text-center">'+data.standard_charge+'<input type="hidden" name="pre_standard_charge[]" value="'+data.standard_charge+'"></td><td class="text-center">'+data.tpa_charge+'<input type="hidden" name="pre_tpa_charges[]" value="'+data.tpa_charge+'"></td><td class="text-center">'+data.amount+'<input type="hidden" name="pre_total[]" value="'+data.amount+'"></td><td class="text-center">'+data.discount_percentage_amount+' ('+data.discount_percentage+'%)<input type="hidden" name="pre_discount_percentage[]" value="'+data.discount_percentage+'"></td><td class="text-center">'+data.tax+' ('+data.tax_percentage+'%)<input type="hidden" name="pre_tax[]" value="'+data.tax+'"><input type="hidden" name="pre_apply_charge[]" value="'+data.apply_charge+'"></td><td class="text-center">'+data.net_amount+'<input type="hidden" name="pre_net_amount[]" value="'+data.net_amount+'"></td><td><label class=""></label><button type="button" class="closebtn delete_row" data-row-id="'+row_id+'" autocomplete="off"><i class="fa-regular fa-remove"></i></button></td></tr>';
