...
<div class="content-wrapper">
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-stethoscope icono-menu-izquierda"></i>
            ...
            <span class="content-header-esconder bread-span"> <?php echo $this->lang->line('opd_out_patient'); ?> <i class="fa-regular fa-chevron-left" style="font-size: 10px; color: #7047ee;"></i> <?php echo $this->lang->line('search_patiente'); ?></span>
            <span style="right: 40px; position: absolute;">
                       <?php if ($this->rbac->hasPrivilege('opd_patient', 'can_add')) { ?>                
                                            <a data-toggle="modal" id="add" onclick="holdModal('myModal')" class="btn btn-primary addpatient"><i class="fa-regular fa-user-plus"></i>  <span class="content-header-esconder"><?php echo $this->lang->line('add_patient'); ?></span></a> 
                                        <?php } ?>                      
            </span>
                 ...
                 <div class="nav-tabs-custom border0">
                    <div class="box box-primary"> 
                        <ul class="nav nav-tabs navlistscroll">
							<li class="active"><a href="#tab_1" data-toggle="tab"><?php echo $this->lang->line('patient_view') ?></a></li>
                            <li><a href="#tab_2" data-toggle="tab"><?php echo $this->lang->line('opd_view') ?></a></li>
                            
                        </ul>
                          <div class="tab-content">
                             <div class="tab-pane active relative pt20" id="tab_1">
                                <div class="topmius35">
                               ...
                               <div class="tab-pane relative pt20" id="tab_2">
                                    <div class="topmius35">
                                       
                                    </div>
                                   <div class="box-body table-responsive">                                   
                                   <table class="table table-striped table-bordered table-hover opd_ajaxlist pt20" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('patient_view'); ?>">
                                        <thead>
    ...
    <div class="modal-dialog pup100" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
				...
				<h4 class="box-title">  <?php echo $this->lang->line('add_patient'); ?></h4> 
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">                            
                                ...
                                <div class="row row-eq h-vh-lg-100-100">
                                    <div class="col-lg-7 col-md-7 col-sm-7">
                                        ...
                                        <div class="row ptt10 around20" id="patientDetails" style="display:none">
                                            <div class="col-md-8 col-sm-8 col-xs-8">
                                                <ul class="singlelist">
                                                    <li class="singlelist24bold">
                                                        <span id="listname"></span></li>
                                                    <li>
                                                        <i class="fa-regular fa-user-tie iconos-paciente" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('guardian'); ?>"></i>
                                                ...
                                                <ul class="multilinelist">   
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-rings-wedding iconos-paciente" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('marital_status'); ?>"></i>
												...
												<ul class="multilinelist">
													...
													<li>
														<i class="fa-regular fa-id-card iconos-paciente" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('national_identification_number'); ?>"></i> 
												...
												<ul class="multilinelist">
                                                    <li id="show_barcode">
                                                        ...
                                                        <span><img src=""  id="getbarcode" height="25" />
                                                        </span>
                                                    </li>
                                                    <li id="show_qrcode">
                                                        ...
                                                        <span>
                                                        <img src=""  id="getqrcode" width="40" height="40" />
                                                        </span>
                                                    </li>
												</ul>
												<ul class="singlelist"> 
                ...
                <div class="modalicon"> 
                    <div id='edit_delete'>
                        <?php if ($this->rbac->hasPrivilege('revisit', 'can_edit')) { ?>
                            <a href="#"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>" ><i class="fa-regular fa-pen-to-square"></i></a>
                            <?php
                        }
