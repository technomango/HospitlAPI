<div class="content-wrapper">
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-users icono-menu-izquierda"></i>
            ...
            <span class="bread-span"> <?php echo $this->lang->line('staff_attendance'); ?> </span>
                                ...
                                if (!empty($resultlist)) {
                                    ...
                                    <form action="<?php echo site_url('admin/staffattendance/index') ?>" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">                                           
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('set_attendance_for_all_staff_as') ; ?> &nbsp;</label><br>
                                                    <?php
                                                    foreach ($attendencetypeslist as $key => $type) {  ?>
                                                            <div class="radio radio-info radio-inline col-md-3">
                                            ...
                                            <table class="table table-hover table-striped">
                                                            ...
                                                            <td>
                                                                ...
                                                                foreach ($attendencetypeslist as $key => $type) {
                                                                        ...
                                                                        if ($value["date"] != "xxx") { ?>
                                                                            ...
                                                                            <div class="radio radio-info radio-inline col-md-5">
											 ...
											 <div class="col-md-12">
                                                ...
                                                if($can_edit==0){
                                                    ...
                                                    <button type="submit" name="search" value="saveattendence" class="btn btn-primary pull-right checkbox-toggle"><i class="fa-regular fa-save"></i> <?php echo $this->lang->line('save_attendance'); ?> </button> <?php
                                              } 
                                                }else{
                                                    if ($this->rbac->hasPrivilege('staff_attendance', 'can_edit')) { ?>
                                                    <button type="submit" name="search" value="saveattendence" class="btn btn-primary pull-right checkbox-toggle"><i class="fa fa-save"></i> <?php echo $this->lang->line('edit_attendance'); ?> </button> <?php
                                                } }
                                                ?>                                     
                                            </div>
                                           </div>
