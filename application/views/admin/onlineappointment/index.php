            ...
            <div class="col-md-9">
                ...
                <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 mt-5">
                                    <label></label>
                                    <div class="form-group">
                                        <button type="button" onclick="search()" class="btn btn-primary"><?php echo $this->lang->line('search'); ?></button>
                                    </div>
                                </div>
                            </div>
                    </form>
                    ...
                    <div class="nav-tabs-custom border0">
                        <ul class="nav nav-tabs" id="myTabs" style="margin: auto 13%;">
                            <?php
                            $count = 1;
                            foreach ($days as $days_key => $days_value) {
                                ...
                                <li <?php echo $cls; ?>><a href="#tab_<?php echo $count; ?>" data-s="<?php echo set_value("shift") ?>" data-d="<?php echo set_value("doctor"); ?>" data-day="<?php echo $days_key; ?>" data-toggle="tab" aria-expanded="true" style="padding: 6px 10px;"><?php echo $days_value; ?></a></li>
                                <?php $count++; } ?>
                        </ul>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".addrow", function () {
            var newRow = $("<tr>");
            var cols = "";
            cols += '<td><input type="hidden" name="total_row[]" value="' + tot_count + '"><input type="hidden" name="prev_id_' + tot_count + '" value="0"><div class="input-group"><div class="input-group-addon"><i class="fa-regular fa-clock"></i></div><input type="text" name="time_from_' + tot_count + '" class="form-control time_from time" id="time_from_' + tot_count + '"  aria-invalid="false"></div></td>';

            cols += '<td><div class="input-group"><div class="input-group-addon"><i class="fa-regular fa-clock"></i></div><input type="text" name="time_to_' + tot_count + '" class="form-control time_to time" id="time_to_' + tot_count + '"  aria-invalid="false"></div></td>';
        
         <?php if ($this->rbac->hasPrivilege('online_appointment_slot', 'can_delete')) { ?>
         
            cols += '<td width="30" class="text-right"><button type="button" class="ibtnDel btn btn-danger btn-xs btn-danger"><i class="fa-regular fa-trash-can"></i></button></td>';
