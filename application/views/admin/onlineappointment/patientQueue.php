...
<div class="content-wrapper">
	<section class="content-header">
        <h1><i class="fa-duotone fa-solid fa-calendars icono-menu-izquierda"></i>
            ...
            <span class="mlr-10">
                <a href="<?php echo site_url('admin/onlineappointment/patientqueue') ?>"> 
                    <i class="fa-light fa-calendar-users"></i>
                </a> 
            </span> 
            <span class="bread-span"> <?php echo $this->lang->line('patient_queue'); ?> </span>
                ...
                <div class="box box-primary around20">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class='input-group'>
                                        ...
                                        <input type='text' id="datetimepicker" value="<?php echo set_value('date'); ?>" class="form-control date" name="date" />
                                    </div>
                        ...
                        <?php if ($this->rbac->hasPrivilege('patient_queue', 'can_edit')) { ?>
                            <button type="submit" name="submit" value="regenerate" class="btn btn-primary"><?php echo $this->lang->line('reorder_queue'); ?></button>
                        <?php } ?>    
                            <button type="submit" name="submit" value="search" class="btn btn-primary"><?php echo $this->lang->line('search') ?></button>
                        </div>
                        </form>
                    </div>
                    ...
                    <div class="box-body">
                        <div class="pull-right">
                            <button type="button" onclick="fnExcelReport();" class="btn btn-default dt-button buttons-excel buttons-html5"><i class="fa-regular fa-file-xls"></i></button>
                            <button type="button" onclick="print_table('myTable');" class="btn btn-default dt-button buttons-print"><i class="fa-regular fa-print"></i></button>
                        </div>
