...
<div class="row clearfix">
    <div class="col-md-12 column">    
                ...
                <table class="table table-bordered table-hover order-list tablewidthRS" id="tab_logic">
                    ...
                    <tbody>
                        ...
                        if (!empty($prev_record)) {
                            ...
                            <tr id='addr0'>
                                ...
                                <?php if ($this->rbac->hasPrivilege('online_appointment_slot', 'can_delete')) { ?>
                                    <button title="<?php echo $this->lang->line('delete'); ?>" class="ibtnDel btn btn-danger btn-xs btn-danger"> <i class="fa-regular fa-trash-can"></i></button>
                                <?php } ?>
                                </td>
                            </tr>
                            <?php
                        ...
                        <tr id='addr0'>
                            ...
                            <td class="text-right" width="30">
                            <?php if ($this->rbac->hasPrivilege('online_appointment_slot', 'can_delete')) { ?>
                                <button class="ibtnDel btn btn-danger btn-xs btn-danger"> <i class="fa-regular fa-trash-can"></i></button>
                            <?php } ?>
                            </td>
                        </tr>
                        <?php
        ...
        <a id="add_row" class="addrow addbtnright btn btn-primary float-left rtl-float-right"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_new'); ?></a>
    <?php } ?>
            </div>
            <?php if ($this->rbac->hasPrivilege('online_appointment_slot', 'can_edit')) { ?>
                <button class="btn btn-primary pull-right" data-loading-text="<?php echo $this->lang->line('processing'); ?>" type="submit"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
            <?php } ?>
          </form>
    </div>
</div>
