                        ...
                        <div class="box-tools pull-right">
                            <div class="box-tools pull-right">
                               <?php if ($this->rbac->hasPrivilege('languages', 'can_add')) { ?>
                                <a href="#" data-target="#myModal" class="btn btn-primary"  data-toggle="modal" title="<?php echo $this->lang->line('add'); ?>" >
                                    <i class="fa-regular fa-plus"></i> <?php echo $this->lang->line('add'); ?>
                                </a>
                            <?php } ?>
                            </div>
                        </div><!-- /.box-tools -->
