								...
								<div class="login-right">
                                    ...
                                    <div class="form-top-left account-logo" style="width: 200px;">
                                		...
                                		<div class="form-bottom">
											...
											<br>
                                    		<p><a href="<?php echo site_url('site/userlogin') ?>" class="forgot"><i class="fa-duotone fa-solid fa-right-to-bracket" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i> <?php echo $this->lang->line('admin_login'); ?></a></p>
                                		</div>
