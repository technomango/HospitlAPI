...
.col-md-offset-3 { margin-left: 29%;}
            ...
            a:hover.forgot {padding-top:0px; color: #2e37a4; text-decoration: none;}
						...
						<div class="login-wrapper">
                            ...
                            <div class="login-right-wrap"> 
								...
								<div class="form-bottom">
									<h3 class="bolds"><?php echo $this->lang->line('reset_password'); ?></h3>
                                <?php
                                ...
                                ?>
									...
									<br>
                                    <p><a href="<?php echo site_url('site/userlogin') ?>" class="forgot"><i class="fa-duotone fa-solid fa-right-to-bracket" style="--fa-primary-color: #2e37a4; --fa-secondary-color: #2e37a4;"></i> <?php echo $this->lang->line('user_login'); ?></a></p>
								</div>
							</div>
						</div>
						</div>
