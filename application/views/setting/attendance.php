                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <div class="form-group">
                                                <label class="col-sm-5 col-lg-4 col-md-5"><?php echo $this->lang->line('devices_separate_by_comma'); ?> </label>
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="col-lg-4 col-md-8 col-sm-6">
                                                            <?php if ($this->rbac->hasPrivilege('attendance_setting', 'can_edit')) { ?>
                                                                <button type="submit" class="btn btn-primary pull-right" data-loading-text="<i class='fa fa-spinner fa-spin '></i><?php echo $this->lang->line('update'); ?>"><?php echo $this->lang->line('update'); ?></button>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                                </div>
