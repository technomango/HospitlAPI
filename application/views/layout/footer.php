...
<footer class="main-footer">
      &copy; Copyright 2012 - 2025 - Mango Technologies - Todos los Derechos Reservados <!-- <?php echo $this->customlib->getAppVersion(); ?> -->
</footer>
...
<script src="<?php echo base_url(); ?>backend/sweetalert2/dist/sweetalert2.min.js"></script>
...
<script src="<?php echo base_url() ?>backend/fullcalendar/dist/locale/es.js"></script>
...
<div id="bed" class="modal fade bedmodal" role="dialog">
    <div class="modal-dialog modal-camas">
        <!-- Modal content-->
...
<?php }?>
    ...
    $(document).ready(function (e) {
       ...
       $(function() {
		   if ($('.time').length > 0 && $('.time').is('input')) {
           $('.time').datetimepicker({
               format: time_format
           });
		}
