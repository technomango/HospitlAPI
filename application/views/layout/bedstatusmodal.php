...
<fieldset class="floormain">
    <legend class="leyenda-arriba"><h4><?php echo $floor["name"] ?></h4></legend>
    <div class="row">
     <?php foreach ($bedgroup_list as $key => $bedgroup) { 
                ...
                <div class="col-md-12 relative">
                    <fieldset style="background-color:<?php echo $bedgroup['color'];?>" ><!-- /class="bedgroups"/ -->
                        <legend class="text-center floorwardbg leyenda-abajo"><h4><?php echo $bedgroup["name"] ?></h4></legend>
                        <div class="row camas-centradas">   
