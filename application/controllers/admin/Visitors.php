    ...
    public function getvisitorsdatatable()
    {
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                if ($value->image !== "") {
                    $action .= "<a href=" . base_url() . 'admin/visitors/download/' . $value->image . " class='btn btn-default btn-xs pull-right'  data-toggle='tooltip' title=''  data-original-title=" . $this->lang->line('download') . "><i class='fa-regular fa-download' aria-hidden='true'></i></a>";
                }
                ...
                if ($this->rbac->hasPrivilege('visitor_book', 'can_delete')) {
                    ...
                    if ($value->image !== "") {
                        $action .= "<a href='#' onclick=deletevisitorimage('" . $value->id . ',' . $value->image . "') class='btn btn-default btn-xs pull-right'  data-toggle='tooltip' title=''  data-original-title=" . $this->lang->line('delete') . "><i class='fa-regular fa-trash-can' aria-hidden='true'></i></a>";
                    } else {
                        $action .= "<a href='#' onclick=deletevisitor('" . $value->id . "') class='btn btn-default btn-xs pull-right'  data-toggle='tooltip' title=''  data-original-title=" . $this->lang->line('delete') . "><i class='fa-regular fa-trash-can' aria-hidden='true'></i></a>";
                    }

                }
                
                if ($this->rbac->hasPrivilege('visitor_book', 'can_edit')) {
                    $action .= "<a href='#'  class='btn btn-default btn-xs pull-right'  data-toggle='tooltip' title=" . $this->lang->line('edit') . " onclick=get(" . $value->id . ")><i class='fa-regular fa-pen-to-square' aria-hidden='true'></i></a>";
                }
                
                $action .= "<a href='#' data-toggle='tooltip' class='btn btn-default btn-xs pull-right'  title='" . $this->lang->line('show') . "'    data-target='#visitordetails' data-original-title='" . $this->lang->line('view') . "' onclick='getRecord(" . $value->id . ")'>  <i class='fa-regular fa-eye'></i> </a>";
