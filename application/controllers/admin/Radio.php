...
class Radio extends Admin_Controller
{
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                if ($this->rbac->hasPrivilege('radiology_partial_payment', 'can_view')) {
                    $action .= "<a href='javascript:void(0)'  data-loading-text='" . $this->lang->line('please_wait') . "' data-record-id='" . $value->id . "' class='btn btn-default btn-xs add_payment' data-toggle='tooltip' title='" . $this->lang->line('add_view_payments') . "' ><i class='fa-regular fa-money'></i></a>";
                }
    ...
    public function getPatientRadiologyDetails()
    {
        ...
        if (isset($is_bill)) {
            ...
            $actions .= "<a href='javascript:void(0)' data-placement='bottom' data-loading-text='" . $this->lang->line('please_wait') . "' class='print_parameter' data-toggle='tooltip' data-record-id=\"" . $id . "\"   data-original-title='" . $this->lang->line('print_test_report') . "'><i class='fa-regular fa-reorder'></i></a>";
            $actions .= "<a href='javascript:void(0)' data-placement='bottom' data-loading-text='" . $this->lang->line('please_wait') . "' class='print_bill' data-toggle='tooltip' data-record-id=\"" . $id . "\"   data-original-title='" . $this->lang->line('print_bill') . "'><i class='fa-regular fa-print'></i></a>";
            if ($this->rbac->hasPrivilege('radiology_bill', 'can_edit')) {
                $actions .= "<a href='javascript:void(0)' data-loading-text='" . $this->lang->line('please_wait') . "' class='edit_radiology' data-toggle='tooltip' data-record-id=\"" . $id . "\"   data-placement='bottom' data-original-title='" . $this->lang->line('edit_radiology') . "'><i class='fa-regular fa-pen-to-square'></i></a>";
            }
            if ($this->rbac->hasPrivilege('radiology_bill', 'can_delete')) {
                $actions .= "<a href='javascript:void(0)' data-placement='bottom' data-loading-text='<i class=\"fa fa-circle-o-notch fa-spin\"></i>' class='delete_radiology' data-toggle='tooltip' data-record-id=\"" . $id . "\"   data-original-title='" . $this->lang->line('delete') . "'><i class='fa-regular fa-trash-can'></i></a>";
            }
    ...
    {
        $id = $this->input->post('id');
        $radiology_center = "Laboratorio de Radiología Interno";
    ...
    public function getradiologytestDatatable()
    {
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                if ($this->rbac->hasPrivilege('radiology_test', 'can_view')) {
                    $action .= "<a href='#' data-toggle='tooltip' onclick='viewDetail(" . $value->id . ")'  class='btn btn-default btn-xs' title='" . $this->lang->line('show') . "' ><i class='fa-regular fa-eye'></i></a>";
                }
                $action .= "</div'>";
				$currency_symbol = $this->customlib->getHospitalCurrencyFormat();
                //==============================
                ...
                $row[]     = $currency_symbol . (number_format($value->standard_charge + calculatePercent($value->standard_charge, $value->percentage), 2, '.', ''));
                $dt_data[] = $row;
            }
        }
        $json_data = array(
