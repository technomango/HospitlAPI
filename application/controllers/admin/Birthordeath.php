    ...
    public function getbirthDatatable()
    {
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                $column_first .= "<a href='#' onclick='viewDetail(" . $value->id . ")' class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('show') . "'><i class='fa-regular fa-eye'></i></a>";

                if ($this->rbac->hasPrivilege('birth_record', 'can_edit')) {
                    $column_first .= "<a href='#' onclick='getRecord(" . $value->id . ")' class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('edit') . "'><i class='fa-regular fa-pen-to-square'></i></a>";
                }

                if ($this->rbac->hasPrivilege('birth_record', 'can_delete')) {
                    $column_first .= "<a class='btn btn-default btn-xs' data-toggle='tooltip' title='' onclick='delete_bill(" . $value->id . ")' data-original-title='" . $this->lang->line('delete') . "'><i class='fa-regular fa-trash-can'></i></a>";
                }
                if($value->gender){
    ...
    public function getdeathDatatable()
    {
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                if ($value->attachment != "") {
                    $column_first .= "<a class='btn btn-default btn-xs' data-toggle='tooltip' title='' href=" . site_url('admin/birthordeath/download_deathrecord/' . $value->id) . " data-original-title='" . $this->lang->line('attachment') . "'><i class='fa-regular fa-download'></i></a>";
                }
