 ...
 */
    ...
    { 
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                $action .= "<a href=" . base_url() . 'admin/patient/profile/' . $value->pid . " class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('show') . "'><i class='fa-regular fa-eye' aria-hidden='true'></i></a>";
                $action .= "</div'>";
                $first_action = "<a href=" . base_url() . 'admin/patient/profile/' . $value->pid . ">";
				$image_paciente = "<img class='paciente_image' src='" . base_url() . "";
                if($value->gender){
                ...
                //==============================
				$row[] = $image_paciente . $value->image . "'>";
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                if ($this->rbac->hasPrivilege('opd_print_bill', 'can_view')) {
                    $action .= "<a href='javascript:void(0)' data-loading-text='<i class=\"fa fa-circle-o-notch fa-spin\"></i>' data-opd-id=" . $opd_id . " data-record-id=" . $visit_details_id . " class='btn btn-default btn-sm print_visit_bill'  data-toggle='tooltip' title='" . $this->lang->line('print_bill') . "'><i class='fa-light fa-file-invoice'></i></a>";
                }
                if ($result[$key]['prescription'] == 'no') {
                    if ($this->rbac->hasPrivilege('prescription', 'can_add')) {
                        $action .= "<a href='#' onclick='getRecord_id(" . $visit_details_id . ")' class='btn btn-default btn-sm'  data-toggle='tooltip' title='" . $this->lang->line('add_prescription') . "'><i class='fa-light fa-files-medical'></i></a>";
                    }
                } elseif ($result[$key]['prescription'] == 'yes') {
                    if ($this->rbac->hasPrivilege('prescription', 'can_view')) {
                        $action .= "<a href='#' onclick='view_prescription(" . $visit_details_id . ")' class='btn btn-default btn-sm'  data-toggle='tooltip' title='" . $this->lang->line('view_prescription') . "'><i class='fa-light fa-file-prescription'></i></a>";
                    }
                }
                if ($this->rbac->hasPrivilege('manual_prescription', 'can_view')) {
                    $action .= "<a href='#' onclick='viewmanual_prescription(" . $visit_details_id . ")' class='btn btn-default btn-sm'  data-toggle='tooltip' title='" . $this->lang->line('manual_prescription') . "'><i class='fa-light fa-print'></i></a>";
                }
                $action .= "<a href='javascript:void(0)' data-loading-text='" . $this->lang->line('please_wait') . "' data-opd-id=" . $opd_id . " data-record-id=" . $visit_details_id . " class='btn btn-default btn-sm get_opd_detail'  data-toggle='tooltip' title='" . $this->lang->line('show') . "'><i class='fa-light fa-eye'></i></a>";
                if (!$value->is_ipd_moved) {
                    if ($this->rbac->hasPrivilege('opd_move_patient_in_ipd', 'can_view')) {
                        $action .= "<a href='javascript:void(0)' data-toggle='tooltip'  data-original-title='" . $this->lang->line('move_in_ipd') . "' class='btn btn-default btn-sm move_opd' data-opd-id=" . $this->opd_prefix . $opd_id . " data-record-id=" . $visit_details_id . "><i class='fa-light fa-share'></i></a>";
                    }
                }
    ...
    public function getopdvisitdatatable()
    {
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                if ($this->rbac->hasPrivilege('opd_print_bill', 'can_view')) {
                    $action .= "<a href='javascript:void(0)' data-loading-text='<i class=\"fa fa-circle-o-notch fa-spin\"></i>' data-opd-id=" . $opd_id . " data-record-id=" . $visit_details_id . " class='btn btn-default btn-xs print_visit_bill'  data-toggle='tooltip' title='" . $this->lang->line('print_bill') . "'><i class='fa-regular fa-print'></i></a>";
                }

                if ($result[$key]['prescription'] == 'no') {
                    if ($this->rbac->hasPrivilege('prescription', 'can_add')) {
                        $action .= "<a href='#' onclick='getRecord_id(" . $visit_details_id . ")' class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('add_prescription') . "'><i class='fa-regular fa-prescription'></i></a>";
                    }
                } elseif ($result[$key]['prescription'] == 'yes') {
                    if ($this->rbac->hasPrivilege('prescription', 'can_view')) {
                        $action .= "<a href='#' onclick='view_prescription(" . $visit_details_id . ")' class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('view_prescription') . "'><i class='fa-regular fa-file-prescription'></i></a>";
                    }
                }

                if ($this->rbac->hasPrivilege('manual_prescription', 'can_view')) {
                    $action .= "<a href='#' onclick='viewmanual_prescription(" . $visit_details_id . ")' class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('manual_prescription') . "'><i class='fa-regular fa-file'></i></a>";
                }

                $action .= "<a href='javascript:void(0)' data-loading-text='" . $this->lang->line('please_wait') . "' data-opd-id=" . $opd_id . " data-record-id=" . $visit_details_id . " class='btn btn-default btn-xs get_opd_detail'  data-toggle='tooltip' title='" . $this->lang->line('show') . "'><i class='fa-regular fa-eye'></i></a>";
    ...
    public function getvisitdatatable($opdid)
    {
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                if ($this->rbac->hasPrivilege('prescription', 'can_add')) {
                    ...
                    if ($result[$key]['prescription'] == 'no') {
                        if ($this->customlib->checkDischargePatient($value->discharged)) {
                            $action .= "<a href='#'  onclick='getRecord_id(" . $value->visit_id . ")' class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('add_prescription') . "'><i class='fa-regular fa-prescription'></i></a>";
                        }
                    } elseif ($result[$key]['prescription'] == 'yes') {
                        $action .= "<a href='#'  onclick='view_prescription(" . $visit_details_id . ")' class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('view_prescription') . "'><i class='fa-regular fa-file-prescription'></i></a>";
                    }
                ...
                if ($this->rbac->hasPrivilege('manual_prescription', 'can_view')) {
                    $action .= "<a href='#'  onclick='viewmanual_prescription(" . $visit_details_id . ")' class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('manual_prescription') . "'><i class='fa-regular fa-print'></i></a>";
                }
                ...
                $action .= "<a href='javascript:void(0)'  data-loading-text='" . $this->lang->line('please_wait') . "' data-record-id=" . $visit_details_id . " class='btn btn-default btn-xs get_opd_detail'  data-toggle='tooltip' title='" . $this->lang->line('show') . "'><i class='fa-regular fa-eye'></i></a>";
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                if ($this->rbac->hasPrivilege('opd_charges', 'can_delete')) {
                    $action .= "<a href='#' onclick='deleterecord(" . $value->patient_id . ',' . $value->opd_id . ',' . $value->id . ")' class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('delete') . "'><i class='fa-regular fa-trash-can'></i></a>";
                }
    ...
    public function getpaymentdatatable()
    {
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                if ($this->rbac->hasPrivilege('opd_charges', 'can_delete')) {
                    $action .= "<a href='#' onclick='deleterecord(" . $value->patient_id . ',' . $value->opd_details_id . ',' . $value->id . ")' class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('delete') . "'><i class='fa-regular fa-trash-can'></i></a>";
                }
    ...
    public function opdvisit_search()
    {
        ...
        foreach ($resultlist as $result_key => $result_value) {
            ...
            $action .= "<a href='#' onclick='getRecord(" . $result_value['patientid'] . ',' . $result_value['opdid'] . ',' . $result_value['id'] . ")' class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('show') . "'><i class='fa-regular fa-eye' ></a>";
            $action .= "</div'>";
    ...
    public function getipddatatable()
    {
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                if ($this->rbac->hasPrivilege('ipd_patient', 'can_view')) {
                    $action .= "<a href=" . base_url() . 'admin/patient/ipdprofile/' . $value->ipdid . " class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('show') . "'><i class='fa-regular fa-eye' aria-hidden='true'></i></a>";
                }
    ...
    public function getdischargeddatatable()
    {
        ...
        if (!empty($dt_response->data)) {
            ...
            foreach ($dt_response->data as $key => $value) {
                ...
                $action  = "<div class='rowoptionview rowview-mt-19'>";
                $action .= "<a title=".$this->lang->line('view')." href=" . base_url() . 'admin/patient/ipdprofile/' . $value->ipdid . "><i class='fa-regular fa-eye' aria-hidden='true'></i></a>";
                $action .= "</div'>";
                $first_action = "<a href=" . base_url() . 'admin/patient/ipdprofile/' . $value->ipdid . ">";
                $row[]        = $first_action . $value->patient_name . "</a>" . $action;
                $row[]        = $value->id;
    ...
    public function ipddischargedreports()
    {
        ...
        if (!empty($reportdata->data)) {
            foreach ($reportdata->data as $key => $value) {
                ...
                $action = "";
                $action = "<div class='rowoptionview rowview-mt-19'>";
                $action .= "<a target='_blank' href=" . site_url('admin/patient/ipdprofile/' . $value->id) . " class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('show') . "'><i class='fa-regular fa-eye' aria-hidden='true'></i></a>";
                $action .= "</div'>";
    ...
    public function opddischargedreports()
    {
        ...
        if (!empty($reportdata->data)) {
            foreach ($reportdata->data as $key => $value) {
                ...
                $action = "";
                $action = "<div class='rowoptionview rowview-mt-19'>";
                $action .= "<a target='_blank' href=" . base_url('admin/patient/visitdetails/' . $value->patient_id . '/' . $value->id) . " class='btn btn-default btn-xs'  data-toggle='tooltip' title='" . $this->lang->line('show') . "'><i class='fa-regular fa-eye' aria-hidden='true'></i></a>";
                $action .= "</div'>";
    ...
    public function patientDetails()
    {
        ...
        $result                = $this->patient_model->getpatientDetails($id);
        $result['gender'] = $this->lang->line(strtolower($result['gender']));
		$result['address'] = $this->lang->line(strtolower($result['address']));
        $result['patient_age'] = $this->customlib->getPatientAge($result['age'], $result['month'], $result['day']);
    ...
    public function getinvestigationparameter()
    {
        ...
        if ($lab == 'pathology') {
            ...
            $actions = "<a href='javascript:void(0)' data-loading-text='<i class=\"fa fa-circle-o-notch fa-spin\"></i>' class='print_bill' data-toggle='tooltip' data-record-id=\"" . $id . "\" data-type-id='" . $lab . "'  data-original-title='" . $this->lang->line('print_bill') . "'><i class='fa-regular fa-print'></i></a>";
